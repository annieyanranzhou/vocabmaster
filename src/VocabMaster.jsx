...
const ADVERBIAL_QUESTIONS = [
  ...
  {q:"She didn't realize the truth _____ years later.", a:"until", opts:["until","when","since","after"], cn:"直到多年以后她才意识到真相。", tip:"not...until 直到...才"},
  {q:"_____ he had left, I found his wallet on the table.", a:"After", opts:["After","Before","Until","While"], cn:"他走了之后，我发现他的钱包落在了桌上。", tip:"after 引导时间状语从句"},
  {q:"We should finish the report _____ the deadline.", a:"before", opts:["before","after","since","until"], cn:"我们应该在截止日期之前完成报告。", tip:"before 引导时间状语从句"},
  {q:"_____ the movie ended, the audience burst into applause.", a:"When", opts:["When","While","Until","Before"], cn:"电影结束时，观众爆发出掌声。", tip:"when 引导时间状语从句"},
  {q:"He has changed a lot _____ we last met.", a:"since", opts:["since","when","after","until"], cn:"自从我们上次见面以来，他变了很多。", tip:"since 引导时间状语从句，表起点"},
  {q:"_____ he was sleeping, his mother prepared breakfast.", a:"While", opts:["While","When","After","Until"], cn:"他睡觉的时候，妈妈准备了早饭。", tip:"while 引导时间状语从句，两个同时动作"},
  {q:"I'll wait _____ you are ready.", a:"until", opts:["until","when","since","while"], cn:"我会等到你准备好。", tip:"until 表等到"},
  {q:"No sooner had he arrived _____ it began to rain.", a:"than", opts:["than","when","before","until"], cn:"他刚到就下起雨来。", tip:"no sooner...than 一...就..."},
  {q:"Hardly had she sat down _____ the phone rang.", a:"when", opts:["when","than","before","until"], cn:"她刚坐下电话就响了。", tip:"hardly...when 一...就..."},
  {q:"_____ I heard the alarm, I ran out of the building.", a:"The moment", opts:["The moment","The reason","The way","The place"], cn:"我一听到警报就跑出了大楼。", tip:"the moment = as soon as 一...就..."},
  {q:"Each time I visit, she _____ me a cup of tea.", a:"makes", opts:["makes","made","has made","is making"], cn:"每次我去拜访，她都给我泡杯茶。", tip:"each time 每次，引导时间状语从句"},
  {q:"I will tell him the news _____ he comes.", a:"when", opts:["when","if","that","which"], cn:"他来的时候我会告诉他这个消息。", tip:"when 引导时间状语从句，主将从现"},
  {q:"_____ you finish your homework, you can go out.", a:"Once", opts:["Once","Unless","Although","Because"], cn:"你一完成作业就可以出去。", tip:"once 一旦，引导时间状语从句"},
  {q:"By the time she arrived, we _____ already left.", a:"had", opts:["had","have","were","did"], cn:"她到达时，我们已经走了。", tip:"by the time + 过去时 → 主句过去完成时"},
  {q:"Every time he sees a dog, he _____ scared.", a:"gets", opts:["gets","got","has got","getting"], cn:"每次看到狗他都会害怕。", tip:"every time 每次，引导时间状语从句"},
  {q:"We were about to leave _____ the rain stopped.", a:"when", opts:["when","while","before","until"], cn:"我们正要离开，这时雨停了。", tip:"be about to...when 正要...这时"},
  {q:"She has made great progress _____ she joined the team.", a:"since", opts:["since","when","after","before"], cn:"自从她加入团队以来，进步很大。", tip:"since + 过去时间点，主句用完成时"},
  {q:"I'll give you a call _____ I get to the airport.", a:"as soon as", opts:["as soon as","as long as","as far as","as much as"], cn:"我一到机场就给你打电话。", tip:"as soon as 一...就...，主将从现"},
  {q:"_____ we were having dinner, the lights went out.", a:"While", opts:["While","When","Until","Since"], cn:"我们正在吃晚饭时停电了。", tip:"while 表两个同时发生的动作"},
  {q:"He didn't leave _____ the meeting was over.", a:"until", opts:["until","when","since","while"], cn:"他直到会议结束才离开。", tip:"not...until 直到...才"},
  {q:"_____ the sun set, the temperature dropped quickly.", a:"Once", opts:["Once","Unless","Although","Because"], cn:"太阳一落山，气温迅速下降。", tip:"once 一旦，引导时间状语从句"},
  {q:"It was not _____ midnight that he returned home.", a:"until", opts:["until","when","since","before"], cn:"直到半夜他才回家。", tip:"It was not until...that... 强调句型"},
  {q:"_____ had he sat down when the door opened.", a:"Scarcely", opts:["Scarcely","Although","Because","Unless"], cn:"他刚坐下门就打开了。", tip:"scarcely...when 一...就...，倒装"},
  {q:"The children ran inside _____ it started thundering.", a:"as soon as", opts:["as soon as","as long as","as far as","as well as"], cn:"一打雷孩子们就跑进了屋子。", tip:"as soon as 一...就..."},
  {q:"I haven't seen her _____ she moved to Shanghai.", a:"since", opts:["since","for","when","until"], cn:"自从她搬到上海后我就没见过她。", tip:"since 自从，主句用完成时"},

  // ── 原因状语从句 (25题) ──────────────────────────────────────
  {q:"He stayed home _____ he was sick.", a:"because", opts:["because","although","unless","so that"], cn:"他待在家里因为他生病了。", tip:"because 引导原因状语从句"},
  {q:"_____ it was raining, we cancelled the picnic.", a:"Since", opts:["Since","Although","Unless","While"], cn:"既然下雨了，我们取消了野餐。", tip:"since 引导原因状语从句，表已知原因"},
  {q:"She missed the bus _____ she got up late.", a:"because", opts:["because","so that","although","if"], cn:"她错过了公交车因为她起晚了。", tip:"because 引导原因状语从句"},
  {q:"_____ you are here, let's discuss it now.", a:"Now that", opts:["Now that","Even if","Unless","While"], cn:"既然你在这儿，我们现在讨论吧。", tip:"now that 既然，引导原因状语从句"},
  {q:"He didn't come to the party _____ he had too much work.", a:"because", opts:["because","although","unless","while"], cn:"他没来参加聚会因为他工作太多。", tip:"because 引导原因状语从句"},
  {q:"_____ the weather was bad, the game was postponed.", a:"As", opts:["As","Although","Unless","While"], cn:"由于天气不好，比赛被推迟了。", tip:"as 引导原因状语从句"},
  {q:"She was praised _____ she had worked very hard.", a:"because", opts:["because","although","unless","when"], cn:"她被表扬了因为她非常努力。", tip:"because 引导原因状语从句"},
  {q:"_____ everyone agrees, let's start the project.", a:"Since", opts:["Since","Although","Unless","Before"], cn:"既然大家都同意，我们开始吧。", tip:"since 引导原因状语从句"},
  {q:"He failed the exam, not _____ he wasn't smart, but _____ he didn't study.", a:"because...because", opts:["because...because","although...although","if...if","when...when"], cn:"他考试不及格，不是因为不聪明，而是因为没学习。", tip:"not because...but because... 不是因为...而是因为..."},
  {q:"_____ he is experienced, he was chosen as the team leader.", a:"Since", opts:["Since","Although","Unless","Before"], cn:"既然他有经验，他被选为队长。", tip:"since 引导原因状语从句"},
  {q:"The roads were wet _____ it had rained all night.", a:"because", opts:["because","although","unless","before"], cn:"路面湿滑因为下了一整夜的雨。", tip:"because 引导原因状语从句"},
  {q:"_____ she speaks fluent French, she was sent to Paris.", a:"As", opts:["As","Although","If","While"], cn:"因为她法语说得流利，她被派去巴黎了。", tip:"as 引导原因状语从句，语气较轻"},
  {q:"He felt cold _____ he had forgotten his coat.", a:"because", opts:["because","although","unless","until"], cn:"他觉得冷因为他忘了带外套。", tip:"because 引导原因状语从句"},
  {q:"_____ you have already finished, you may leave early.", a:"Now that", opts:["Now that","Even if","Unless","Before"], cn:"既然你已经完成了，可以早走。", tip:"now that 既然，已知事实"},
  {q:"I couldn't sleep _____ the noise outside was too loud.", a:"because", opts:["because","although","unless","while"], cn:"我睡不着因为外面噪音太大了。", tip:"because 引导原因状语从句"},
  {q:"She was late for school, _____ the traffic was heavy.", a:"for", opts:["for","but","so","or"], cn:"她上学迟到了，因为交通拥堵。", tip:"for 引导原因状语从句，较正式"},
  {q:"He is respected by all _____ he is honest and kind.", a:"because", opts:["because","although","unless","if"], cn:"他受到大家尊重因为他诚实善良。", tip:"because 引导原因状语从句"},
  {q:"_____ it was getting late, we decided to go home.", a:"As", opts:["As","Although","Unless","While"], cn:"因为天色渐晚，我们决定回家。", tip:"as 引导原因状语从句"},
  {q:"The match was cancelled _____ of the heavy rain.", a:"because", opts:["because","in spite","instead","regardless"], cn:"比赛因为大雨而被取消了。", tip:"because of + 名词短语，表原因"},
  {q:"_____ you don't feel well, you should see a doctor.", a:"Since", opts:["Since","Although","Unless","While"], cn:"既然你不舒服，应该去看医生。", tip:"since 引导原因状语从句"},
  {q:"The flowers died _____ nobody watered them.", a:"because", opts:["because","although","unless","before"], cn:"花枯死了因为没人浇水。", tip:"because 引导原因状语从句"},
  {q:"She was absent from class _____ she was ill.", a:"because", opts:["because","although","unless","until"], cn:"她缺课是因为她生病了。", tip:"because 引导原因状语从句"},
  {q:"He practises every day _____ he wants to be perfect.", a:"because", opts:["because","although","unless","so that"], cn:"他每天练习因为他想要做到完美。", tip:"because 引导原因状语从句"},
  {q:"_____ the road was icy, the driver slowed down.", a:"Because", opts:["Because","Although","Unless","While"], cn:"因为路面结冰，司机减速了。", tip:"because 引导原因状语从句"},
  {q:"We should hurry _____ we might miss the train.", a:"because", opts:["because","although","unless","until"], cn:"我们应该快点因为可能会错过火车。", tip:"because 引导原因状语从句"},

  // ── 条件状语从句 (30题) ──────────────────────────────────────
  {q:"_____ you study hard, you will pass the exam.", a:"If", opts:["If","Although","Because","While"], cn:"如果你努力学习，你会通过考试的。", tip:"if 引导条件状语从句，主将从现"},
  {q:"She won't come _____ you invite her personally.", a:"unless", opts:["unless","if","although","because"], cn:"除非你亲自邀请她，否则她不会来。", tip:"unless = if...not 除非"},
  {q:"_____ it rains tomorrow, we'll go hiking.", a:"Unless", opts:["Unless","If","Because","While"], cn:"除非明天下雨，否则我们去远足。", tip:"unless = if...not 除非"},
  {q:"You can borrow my car _____ you drive carefully.", a:"as long as", opts:["as long as","as soon as","as far as","as well as"], cn:"只要你开车小心，可以借我的车。", tip:"as long as 只要，引导条件状语从句"},
  {q:"_____ you need help, just let me know.", a:"If", opts:["If","Although","Because","While"], cn:"如果你需要帮助，告诉我就行。", tip:"if 引导条件状语从句"},
  {q:"We'll start on time _____ everyone arrives.", a:"provided that", opts:["provided that","even though","in case","so that"], cn:"如果大家都到了，我们准时开始。", tip:"provided that 只要，条件状语从句"},
  {q:"_____ I were you, I would accept the offer.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果我是你，我会接受这个提议。", tip:"if I were you 虚拟语气条件句"},
  {q:"She always brings an umbrella _____ it rains.", a:"in case", opts:["in case","so that","even if","unless"], cn:"她总是带伞以防下雨。", tip:"in case 以防，引导条件状语从句"},
  {q:"_____ you had told me earlier, I could have helped.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果你早点告诉我，我本可以帮忙的。", tip:"if + had done 虚拟语气，与过去事实相反"},
  {q:"Take a map with you _____ you get lost.", a:"in case", opts:["in case","so that","unless","because"], cn:"带张地图以防迷路。", tip:"in case 以防万一"},
  {q:"_____ you should change your mind, please let us know.", a:"If", opts:["If","Although","Because","Unless"], cn:"万一你改变主意，请告诉我们。", tip:"if + should 表万一"},
  {q:"You can go to the party _____ you finish your homework first.", a:"on condition that", opts:["on condition that","even though","so that","in order that"], cn:"只要你先做完作业就可以去派对。", tip:"on condition that 以...为条件"},
  {q:"_____ it were not for your help, I would have failed.", a:"If", opts:["If","Although","Because","Unless"], cn:"要不是你帮忙，我就失败了。", tip:"if it were not for 要不是"},
  {q:"I won't go _____ she goes too.", a:"unless", opts:["unless","if","because","although"], cn:"除非她也去，否则我不去。", tip:"unless = if...not 除非"},
  {q:"_____ he had more time, he would travel around the world.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果他有更多时间，他会环游世界。", tip:"if + 过去式，虚拟语气，与现在事实相反"},
  {q:"You may use my computer _____ you return it by Friday.", a:"as long as", opts:["as long as","as soon as","as far as","as well as"], cn:"只要你周五前归还就可以用我的电脑。", tip:"as long as 只要"},
  {q:"_____ anything goes wrong, call me immediately.", a:"If", opts:["If","Although","Because","Unless"], cn:"万一出了什么问题，立刻给我打电话。", tip:"if 引导条件状语从句"},
  {q:"She will succeed _____ she keeps trying.", a:"as long as", opts:["as long as","as soon as","even though","so that"], cn:"只要她继续努力就会成功。", tip:"as long as 只要"},
  {q:"_____ they offer me the job, I will take it.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果他们给我这份工作，我会接受的。", tip:"if 引导条件状语从句"},
  {q:"He won't succeed _____ he works harder.", a:"unless", opts:["unless","if","because","although"], cn:"除非他更努力，否则不会成功。", tip:"unless = if...not 除非"},
  {q:"_____ you mix red and yellow, you get orange.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果你把红色和黄色混合，就会得到橙色。", tip:"if 引导零条件句，科学事实"},
  {q:"I'll lend you the book _____ you promise to return it.", a:"on condition that", opts:["on condition that","even though","so that","in order that"], cn:"我借你这本书，条件是你答应归还。", tip:"on condition that 以...为条件"},
  {q:"_____ it should rain, the event will be moved indoors.", a:"If", opts:["If","Although","Because","Unless"], cn:"万一下雨，活动将移至室内。", tip:"if + should 表万一"},
  {q:"We can start _____ everyone is here.", a:"once", opts:["once","unless","although","because"], cn:"等所有人都到了我们就可以开始。", tip:"once 一旦，引导条件状语从句"},
  {q:"_____ you don't hurry, you'll miss the bus.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果你不快点，就会错过公交车。", tip:"if 引导条件状语从句"},
  {q:"Bring an extra pen _____ yours runs out of ink.", a:"in case", opts:["in case","so that","unless","because"], cn:"多带一支笔以防你的笔没墨了。", tip:"in case 以防万一"},
  {q:"_____ you heat water to 100°C, it boils.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果你把水加热到100度，水就会沸腾。", tip:"if 引导零条件句，科学事实"},
  {q:"He would have come _____ he had known about it.", a:"if", opts:["if","although","because","unless"], cn:"如果他知道这件事的话，他就会来了。", tip:"if + had done 虚拟语气，与过去事实相反"},
  {q:"You'll hurt yourself _____ you're not careful.", a:"if", opts:["if","although","because","unless"], cn:"如果你不小心就会伤到自己。", tip:"if 引导条件状语从句"},
  {q:"_____ necessary, I can stay late tonight.", a:"If", opts:["If","Although","Because","Unless"], cn:"如果需要，今晚我可以待到很晚。", tip:"if necessary 如果有必要，省略从句主语和be"},

  // ── 让步状语从句 (25题) ──────────────────────────────────────
  {q:"_____ she was tired, she continued working.", a:"Although", opts:["Although","Because","If","Unless"], cn:"尽管她很累，但她继续工作。", tip:"although 引导让步状语从句"},
  {q:"He went to school _____ he had a fever.", a:"even though", opts:["even though","because","unless","so that"], cn:"即使发烧了他还是去上学了。", tip:"even though 即使，强调让步"},
  {q:"_____ hard she tried, she couldn't solve the problem.", a:"However", opts:["However","Whatever","Whoever","Whenever"], cn:"无论她多努力，都无法解决这个问题。", tip:"however + adj./adv. 无论多么"},
  {q:"_____ it may seem difficult, don't give up.", a:"Although", opts:["Although","Because","If","Unless"], cn:"虽然看起来很难，但不要放弃。", tip:"although 引导让步状语从句"},
  {q:"_____ happens, I will support you.", a:"Whatever", opts:["Whatever","However","Whenever","Wherever"], cn:"无论发生什么，我都会支持你。", tip:"whatever 引导让步从句，无论什么"},
  {q:"She is kind to everyone _____ they are rich or poor.", a:"whether", opts:["whether","because","if","unless"], cn:"无论贫富她对每个人都很友善。", tip:"whether...or 无论...还是"},
  {q:"_____ he apologized, she refused to forgive him.", a:"Even though", opts:["Even though","Because","If","Unless"], cn:"即使他道了歉，她还是拒绝原谅他。", tip:"even though 即使，引导让步状语从句"},
  {q:"_____ you go, I'll follow you.", a:"Wherever", opts:["Wherever","Whatever","However","Whenever"], cn:"无论你去哪里，我都跟着你。", tip:"wherever 引导让步状语从句，无论哪里"},
  {q:"_____ rich he is, he is not happy.", a:"However", opts:["However","Whatever","Whoever","Whenever"], cn:"无论他多富有，他都不开心。", tip:"however + adj. 无论多么"},
  {q:"He went out _____ the heavy rain.", a:"in spite of", opts:["in spite of","because of","instead of","on behalf of"], cn:"尽管下大雨他还是出去了。", tip:"in spite of + 名词短语，表让步"},
  {q:"_____ she was afraid, she still jumped.", a:"Although", opts:["Although","Because","If","Unless"], cn:"尽管她害怕，她还是跳了。", tip:"although 引导让步状语从句"},
  {q:"_____ you say, I won't change my mind.", a:"No matter what", opts:["No matter what","No matter how","No matter when","No matter where"], cn:"无论你说什么，我都不会改变主意。", tip:"no matter what = whatever 无论什么"},
  {q:"She smiled _____ she was in great pain.", a:"even though", opts:["even though","because","unless","so that"], cn:"即使她非常痛苦，她还是微笑着。", tip:"even though 即使，强调让步"},
  {q:"_____ old he is, he still runs every morning.", a:"However", opts:["However","Whatever","Whoever","Whenever"], cn:"无论他多大年纪，他仍然每天早上跑步。", tip:"however + adj. 无论多么"},
  {q:"_____ the exam was difficult, most students passed.", a:"Although", opts:["Although","Because","If","Unless"], cn:"虽然考试很难，但大多数学生通过了。", tip:"although 引导让步状语从句"},
  {q:"He kept working _____ the difficulties he faced.", a:"despite", opts:["despite","because of","instead of","owing to"], cn:"尽管面临困难，他仍继续工作。", tip:"despite + 名词短语，表让步"},
  {q:"_____ intelligent she is, she still makes mistakes.", a:"However", opts:["However","Whatever","Whoever","Whenever"], cn:"无论她多聪明，她还是会犯错。", tip:"however + adj. 无论多么"},
  {q:"I will go _____ it rains or not.", a:"whether", opts:["whether","because","if","unless"], cn:"无论是否下雨我都会去。", tip:"whether...or not 无论...与否"},
  {q:"_____ she failed many times, she never gave up.", a:"Even though", opts:["Even though","Because","If","Unless"], cn:"即使她失败了很多次，她从未放弃。", tip:"even though 即使，引导让步状语从句"},
  {q:"Child _____ he was, he knew a lot about science.", a:"as", opts:["as","although","because","if"], cn:"虽然他还是个孩子，他懂很多科学知识。", tip:"名词 + as + 主谓，倒装让步结构"},
  {q:"Try _____ he might, he couldn't open the door.", a:"as", opts:["as","although","because","if"], cn:"尽管他尝试了，还是打不开门。", tip:"动词原形 + as + 主语，倒装让步结构"},
  {q:"_____ you like it or not, you have to go.", a:"Whether", opts:["Whether","Because","If","Unless"], cn:"不管你喜不喜欢，你都必须去。", tip:"whether...or not 无论...与否"},
  {q:"He is always cheerful _____ what happens.", a:"no matter", opts:["no matter","because","unless","so that"], cn:"无论发生什么他总是很开朗。", tip:"no matter what 无论什么"},
  {q:"_____ busy she is, she always finds time to read.", a:"However", opts:["However","Whatever","Whoever","Whenever"], cn:"无论她多忙，总能找时间读书。", tip:"however + adj. 无论多么"},
  {q:"Hard _____ it is, we must try our best.", a:"as", opts:["as","although","because","if"], cn:"尽管很难，我们也必须尽全力。", tip:"adj. + as + 主谓，倒装让步结构"},

  // ── 目的状语从句 (25题) ──────────────────────────────────────
  {q:"She studied hard _____ she could pass the exam.", a:"so that", opts:["so that","because","although","unless"], cn:"她努力学习以便能通过考试。", tip:"so that 引导目的状语从句"},
  {q:"He spoke loudly _____ everyone could hear him.", a:"so that", opts:["so that","because","although","unless"], cn:"他大声说话以便大家能听到。", tip:"so that 引导目的状语从句"},
  {q:"She turned off the music _____ the baby could sleep.", a:"so that", opts:["so that","because","although","unless"], cn:"她关了音乐以便婴儿能睡觉。", tip:"so that 引导目的状语从句"},
  {q:"He left early _____ avoid the traffic.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"他早走是为了避开交通。", tip:"in order to + 动词原形，表目的"},
  {q:"She wrote it down _____ she wouldn't forget.", a:"so that", opts:["so that","because","although","unless"], cn:"她写下来以免忘记。", tip:"so that + won't/wouldn't 以免"},
  {q:"They moved to the front _____ they could see better.", a:"so that", opts:["so that","because","although","unless"], cn:"他们移到前面以便看得更清楚。", tip:"so that 引导目的状语从句"},
  {q:"He works hard _____ his family can live comfortably.", a:"so that", opts:["so that","because","although","unless"], cn:"他努力工作以便家人能生活舒适。", tip:"so that 引导目的状语从句"},
  {q:"She saved money _____ buy a new laptop.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"她攒钱为了买一台新电脑。", tip:"in order to + 动词原形，表目的"},
  {q:"Please be quiet _____ the patients can rest.", a:"so that", opts:["so that","because","although","unless"], cn:"请安静以便病人能休息。", tip:"so that 引导目的状语从句"},
  {q:"He studies English _____ he can communicate abroad.", a:"so that", opts:["so that","because","although","unless"], cn:"他学英语以便能在国外交流。", tip:"so that 引导目的状语从句"},
  {q:"She wore a hat _____ protect herself from the sun.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"她戴帽子为了防晒。", tip:"in order to + 动词原形，表目的"},
  {q:"I'll remind you _____ you won't forget the appointment.", a:"so that", opts:["so that","because","although","unless"], cn:"我会提醒你以免你忘了预约。", tip:"so that + won't 以免"},
  {q:"He opened the window _____ fresh air could come in.", a:"so that", opts:["so that","because","although","unless"], cn:"他开窗户以便新鲜空气能进来。", tip:"so that 引导目的状语从句"},
  {q:"She practices piano daily _____ improve her skills.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"她每天练钢琴以提高技巧。", tip:"in order to + 动词原形，表目的"},
  {q:"We set off early _____ we wouldn't be late.", a:"so that", opts:["so that","because","although","unless"], cn:"我们早出发以免迟到。", tip:"so that + wouldn't 以免"},
  {q:"The teacher explains slowly _____ all students can understand.", a:"so that", opts:["so that","because","although","unless"], cn:"老师慢慢讲解以便所有学生都能理解。", tip:"so that 引导目的状语从句"},
  {q:"He locked the door _____ no one could enter.", a:"so that", opts:["so that","because","although","unless"], cn:"他锁了门以免有人进来。", tip:"so that + could not 以免"},
  {q:"She took notes _____ review the lessons later.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"她做笔记以便以后复习。", tip:"in order to + 动词原形，表目的"},
  {q:"We arrived early _____ we could get good seats.", a:"so that", opts:["so that","because","although","unless"], cn:"我们早到以便能占到好位置。", tip:"so that 引导目的状语从句"},
  {q:"I exercise every day _____ stay healthy.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"我每天锻炼以保持健康。", tip:"in order to + 动词原形，表目的"},
  {q:"He turned on the light _____ he could read the map.", a:"so that", opts:["so that","because","although","unless"], cn:"他开灯以便能看地图。", tip:"so that 引导目的状语从句"},
  {q:"She closed the curtains _____ the sunlight wouldn't wake the baby.", a:"so that", opts:["so that","because","although","unless"], cn:"她拉上窗帘以免阳光吵醒婴儿。", tip:"so that + wouldn't 以免"},
  {q:"He speaks clearly _____ avoid misunderstandings.", a:"in order to", opts:["in order to","in spite of","because of","instead of"], cn:"他说得清楚是为了避免误解。", tip:"in order to + 动词原形，表目的"},
  {q:"We brought extra food _____ there wouldn't be enough.", a:"in case", opts:["in case","so that","unless","because"], cn:"我们带了额外的食物以防不够。", tip:"in case 以防，引导目的/条件从句"},
  {q:"She put on sunscreen _____ she wouldn't get sunburned.", a:"so that", opts:["so that","because","although","unless"], cn:"她涂了防晒霜以防晒伤。", tip:"so that + wouldn't 以免"},

  // ── 结果状语从句 (20题) ──────────────────────────────────────
  {q:"She was _____ tired that she fell asleep on the sofa.", a:"so", opts:["so","such","too","very"], cn:"她太累了以至于在沙发上睡着了。", tip:"so + adj. + that 如此...以至于"},
  {q:"It was _____ a wonderful trip that we wanted to go again.", a:"such", opts:["such","so","too","very"], cn:"这次旅行太棒了以至于我们还想再去。", tip:"such + a/an + adj. + n. + that"},
  {q:"He ran _____ fast that no one could catch him.", a:"so", opts:["so","such","too","very"], cn:"他跑得太快了没人能追上他。", tip:"so + adv. + that 如此...以至于"},
  {q:"It rained _____ heavily that the streets were flooded.", a:"so", opts:["so","such","too","very"], cn:"雨下得太大了以至于街道被淹了。", tip:"so + adv. + that 如此...以至于"},
  {q:"He has _____ many friends that he is never lonely.", a:"so", opts:["so","such","too","very"], cn:"他有那么多朋友以至于从不孤单。", tip:"so + many/much/few/little + n. + that"},
  {q:"It was _____ cold weather that we stayed indoors.", a:"such", opts:["such","so","too","very"], cn:"天气太冷了以至于我们待在室内。", tip:"such + adj. + n.(不可数/复数) + that"},
  {q:"She spoke _____ quickly that I couldn't follow her.", a:"so", opts:["so","such","too","very"], cn:"她说得太快了以至于我跟不上。", tip:"so + adv. + that 如此...以至于"},
  {q:"The book was _____ interesting that I finished it in one day.", a:"so", opts:["so","such","too","very"], cn:"这本书太有趣了以至于我一天就看完了。", tip:"so + adj. + that 如此...以至于"},
  {q:"They made _____ much noise that the neighbors complained.", a:"so", opts:["so","such","too","very"], cn:"他们太吵了以至于邻居投诉了。", tip:"so + much + n. + that"},
  {q:"He told _____ a funny joke that everyone laughed.", a:"such", opts:["such","so","too","very"], cn:"他讲了一个如此好笑的笑话以至于大家都笑了。", tip:"such + a/an + adj. + n. + that"},
  {q:"The problem was _____ difficult that nobody could solve it.", a:"so", opts:["so","such","too","very"], cn:"这个问题太难了以至于没人能解决。", tip:"so + adj. + that 如此...以至于"},
  {q:"She has _____ little patience that she gets angry easily.", a:"so", opts:["so","such","too","very"], cn:"她耐心太少以至于很容易生气。", tip:"so + little + 不可数n. + that"},
  {q:"It was _____ an exciting game that we all cheered loudly.", a:"such", opts:["such","so","too","very"], cn:"那是一场如此激动人心的比赛以至于我们都大声欢呼。", tip:"such + a/an + adj. + n. + that"},
  {q:"The road was _____ slippery that several cars crashed.", a:"so", opts:["so","such","too","very"], cn:"路太滑了以至于好几辆车撞了。", tip:"so + adj. + that 如此...以至于"},
  {q:"There were _____ few chairs that some people had to stand.", a:"so", opts:["so","such","too","very"], cn:"椅子太少了以至于有些人只能站着。", tip:"so + few + 可数n.复数 + that"},
  {q:"She danced _____ beautifully that the audience gave her a standing ovation.", a:"so", opts:["so","such","too","very"], cn:"她跳得太美了以至于观众起立鼓掌。", tip:"so + adv. + that 如此...以至于"},
  {q:"It was _____ good news that everyone celebrated.", a:"such", opts:["such","so","too","very"], cn:"这是如此好的消息以至于所有人都庆祝。", tip:"such + adj. + n.(不可数) + that"},
  {q:"The movie was _____ boring that I fell asleep halfway through.", a:"so", opts:["so","such","too","very"], cn:"电影太无聊了以至于我看到一半就睡着了。", tip:"so + adj. + that 如此...以至于"},
  {q:"He ate _____ much food that he could barely walk.", a:"so", opts:["so","such","too","very"], cn:"他吃了太多东西以至于几乎走不动。", tip:"so + much + n. + that"},
  {q:"It was _____ a long journey that we all felt exhausted.", a:"such", opts:["such","so","too","very"], cn:"旅途太长了以至于我们都累坏了。", tip:"such + a/an + adj. + n. + that"},

  // ── 地点状语从句 (10题) ──────────────────────────────────────
  {q:"_____ there is a will, there is a way.", a:"Where", opts:["Where","When","Because","Although"], cn:"有志者事竟成。", tip:"where 引导地点状语从句"},
  {q:"You can sit _____ you like.", a:"wherever", opts:["wherever","whatever","however","whenever"], cn:"你想坐哪里就坐哪里。", tip:"wherever 无论哪里，引导地点状语从句"},
  {q:"We found wild flowers _____ we went.", a:"everywhere", opts:["everywhere","somewhere","anywhere","nowhere"], cn:"我们走到哪里都能发现野花。", tip:"everywhere 到处，引导地点状语从句"},
  {q:"_____ there is water, there is life.", a:"Where", opts:["Where","When","Because","Although"], cn:"哪里有水，哪里就有生命。", tip:"where 引导地点状语从句"},
  {q:"Stay _____ you are and don't move.", a:"where", opts:["where","when","because","although"], cn:"待在原地别动。", tip:"where 引导地点状语从句"},
  {q:"She followed him _____ he went.", a:"wherever", opts:["wherever","whatever","however","whenever"], cn:"他去哪里她就跟到哪里。", tip:"wherever 无论到哪里"},
  {q:"Put the book back _____ you found it.", a:"where", opts:["where","when","because","although"], cn:"把书放回你找到它的地方。", tip:"where 引导地点状语从句"},
  {q:"_____ he goes, he makes friends.", a:"Wherever", opts:["Wherever","Whatever","However","Whenever"], cn:"他走到哪里都能交到朋友。", tip:"wherever 无论到哪里"},
  {q:"Plant the tree _____ there is plenty of sunlight.", a:"where", opts:["where","when","because","although"], cn:"把树种在阳光充足的地方。", tip:"where 引导地点状语从句"},
  {q:"I'll go _____ you go.", a:"wherever", opts:["wherever","whatever","however","whenever"], cn:"你去哪儿我就去哪儿。", tip:"wherever 无论到哪里"},

  // ── 方式状语从句 (15题) ──────────────────────────────────────
  {q:"She looks _____ she has been crying.", a:"as if", opts:["as if","because","although","unless"], cn:"她看起来好像哭过。", tip:"as if 好像，引导方式状语从句"},
  {q:"He talks _____ he knew everything.", a:"as if", opts:["as if","because","although","unless"], cn:"他说话好像什么都知道似的。", tip:"as if + 过去式，虚拟语气"},
  {q:"Do _____ I tell you.", a:"as", opts:["as","like","when","while"], cn:"照我说的做。", tip:"as 引导方式状语从句，按照"},
  {q:"She treated him _____ he were her own son.", a:"as if", opts:["as if","because","although","unless"], cn:"她对待他好像他是自己的亲儿子。", tip:"as if + 过去式，虚拟语气"},
  {q:"Leave things _____ they are.", a:"as", opts:["as","like","when","while"], cn:"让一切保持原样。", tip:"as 引导方式状语从句，按照"},
  {q:"He behaves _____ nothing had happened.", a:"as if", opts:["as if","because","although","unless"], cn:"他表现得好像什么都没发生过。", tip:"as if + had done，与过去事实相反"},
  {q:"She spoke to me _____ I were a child.", a:"as if", opts:["as if","because","although","unless"], cn:"她跟我说话好像我是小孩子一样。", tip:"as if + were，虚拟语气"},
  {q:"Do it _____ the teacher told you.", a:"as", opts:["as","like","when","while"], cn:"按照老师告诉你的去做。", tip:"as 引导方式状语从句，按照"},
  {q:"It looks _____ it is going to rain.", a:"as if", opts:["as if","because","although","unless"], cn:"看起来好像要下雨了。", tip:"as if 好像，引导方式状语从句"},
  {q:"He ran _____ the wind.", a:"like", opts:["like","as","when","while"], cn:"他跑得像风一样快。", tip:"like 像...一样，后接名词"},
  {q:"She acts _____ she owned the place.", a:"as if", opts:["as if","because","although","unless"], cn:"她表现得好像这地方是她的。", tip:"as if + 过去式，虚拟语气"},
  {q:"The house looks _____ no one has lived there for years.", a:"as though", opts:["as though","because","although","unless"], cn:"这房子看起来好像多年没人住过。", tip:"as though = as if 好像"},
  {q:"He ate the meal _____ he hadn't eaten for days.", a:"as if", opts:["as if","because","although","unless"], cn:"他吃饭好像好几天没吃过东西。", tip:"as if + had done，虚拟语气"},
  {q:"We should do _____ the doctor suggests.", a:"as", opts:["as","like","when","while"], cn:"我们应该按医生建议的去做。", tip:"as 引导方式状语从句，按照"},
  {q:"She felt _____ the world had come to an end.", a:"as if", opts:["as if","because","although","unless"], cn:"她觉得好像世界末日到了。", tip:"as if + had done，虚拟语气"},

  // ── 比较状语从句 (15题) ──────────────────────────────────────
  {q:"She is _____ tall as her brother.", a:"as", opts:["as","so","than","more"], cn:"她和她哥哥一样高。", tip:"as...as 同级比较"},
  {q:"He runs faster _____ I do.", a:"than", opts:["than","as","so","like"], cn:"他跑得比我快。", tip:"比较级 + than"},
  {q:"The more you practise, the _____ you become.", a:"better", opts:["better","best","good","well"], cn:"你练习得越多就会变得越好。", tip:"the more...the better 越...越..."},
  {q:"She is not _____ patient as her sister.", a:"as", opts:["as","so","than","more"], cn:"她不如她姐姐有耐心。", tip:"not as...as 不如...那么"},
  {q:"This box is three times _____ heavy as that one.", a:"as", opts:["as","so","than","more"], cn:"这个箱子是那个的三倍重。", tip:"倍数 + as...as 倍数比较"},
  {q:"The harder you work, the _____ you earn.", a:"more", opts:["more","most","much","many"], cn:"你工作越努力，赚得越多。", tip:"the + 比较级...the + 比较级 越...越..."},
  {q:"He is the taller _____ the two boys.", a:"of", opts:["of","than","as","in"], cn:"两个男孩中他更高。", tip:"the + 比较级 + of the two 两者中更...的"},
  {q:"She speaks English much _____ than before.", a:"better", opts:["better","best","good","well"], cn:"她英语说得比以前好多了。", tip:"much + 比较级 + than 比...得多"},
  {q:"This problem is _____ difficult than I expected.", a:"more", opts:["more","most","much","very"], cn:"这个问题比我预期的更难。", tip:"more + 多音节adj. + than 比较级"},
  {q:"He swims as _____ as a fish.", a:"well", opts:["well","good","better","best"], cn:"他游泳游得和鱼一样好。", tip:"as + adv. + as 同级比较"},
  {q:"The sooner we leave, the _____ we arrive.", a:"earlier", opts:["earlier","earliest","early","more early"], cn:"我们越早出发，到得越早。", tip:"the + 比较级...the + 比较级 越...越..."},
  {q:"This book is not _____ interesting as that one.", a:"as", opts:["as","so","than","more"], cn:"这本书不如那本有趣。", tip:"not as...as 不如...那么"},
  {q:"He is _____ of the three brothers.", a:"the tallest", opts:["the tallest","taller","tallest","the taller"], cn:"三兄弟中他最高。", tip:"the + 最高级 + of 三者或以上最...的"},
  {q:"She is older _____ she looks.", a:"than", opts:["than","as","so","like"], cn:"她比看起来年纪大。", tip:"比较级 + than 比...更"},
  {q:"The less you eat, the _____ weight you will lose.", a:"more", opts:["more","most","much","many"], cn:"你吃得越少，减的体重越多。", tip:"the less...the more 越少...越多"},
];
...
const NOUN_CLAUSE_QUESTIONS = [
  ...
  {q:"She asked me _____ I had been to Beijing.", a:"whether", opts:["whether","that","what","how"], cn:"她问我是否去过北京。", tip:"whether 表是否，引导宾语从句"},
  {q:"I believe _____ he is honest.", a:"that", opts:["that","what","which","whether"], cn:"我相信他是诚实的。", tip:"that 引导宾语从句，可省略"},
  {q:"Do you know _____ won the game?", a:"who", opts:["who","whom","which","what"], cn:"你知道谁赢了比赛吗？", tip:"who 引导宾语从句，作主语"},
  {q:"Can you tell me _____ the nearest bank is?", a:"where", opts:["where","what","which","who"], cn:"你能告诉我最近的银行在哪里吗？", tip:"where 引导宾语从句"},
  {q:"I wonder _____ she will accept the offer.", a:"whether", opts:["whether","that","what","how"], cn:"我想知道她是否会接受这个提议。", tip:"wonder 后接 whether/if 表是否"},
  {q:"He said _____ he would come tomorrow.", a:"that", opts:["that","what","which","whether"], cn:"他说他明天会来。", tip:"that 引导宾语从句"},
  {q:"I can't imagine _____ life would be like without music.", a:"what", opts:["what","that","which","how"], cn:"我无法想象没有音乐的生活会是什么样。", tip:"what 引导宾语从句"},
  {q:"She didn't tell me _____ she was going.", a:"where", opts:["where","what","which","who"], cn:"她没告诉我她要去哪里。", tip:"where 引导宾语从句"},
  {q:"Do you remember _____ we first met?", a:"when", opts:["when","what","which","who"], cn:"你记得我们第一次见面是什么时候吗？", tip:"when 引导宾语从句"},
  {q:"I'm not sure _____ color she prefers.", a:"which", opts:["which","what","that","whether"], cn:"我不确定她更喜欢哪种颜色。", tip:"which 引导宾语从句，在已知范围中选择"},
  {q:"He asked _____ the meeting would start.", a:"when", opts:["when","what","which","who"], cn:"他问会议什么时候开始。", tip:"when 引导宾语从句"},
  {q:"Please tell me _____ you need.", a:"what", opts:["what","that","which","whether"], cn:"请告诉我你需要什么。", tip:"what 引导宾语从句"},
  {q:"She wondered _____ to do next.", a:"what", opts:["what","that","which","whether"], cn:"她想知道接下来该做什么。", tip:"what + to do 引导宾语从句"},
  {q:"I didn't understand _____ he meant.", a:"what", opts:["what","that","which","whether"], cn:"我不明白他是什么意思。", tip:"what 引导宾语从句"},
  {q:"Nobody knows _____ he comes from.", a:"where", opts:["where","what","which","who"], cn:"没人知道他来自哪里。", tip:"where 引导宾语从句"},
  {q:"He couldn't decide _____ to stay or to leave.", a:"whether", opts:["whether","that","what","how"], cn:"他无法决定是留下还是离开。", tip:"whether...or 引导宾语从句，表选择"},
  {q:"She explained _____ the machine worked.", a:"how", opts:["how","what","that","which"], cn:"她解释了这台机器是如何运作的。", tip:"how 引导宾语从句"},
  {q:"I doubt _____ he will keep his promise.", a:"whether", opts:["whether","that","what","how"], cn:"我怀疑他是否会信守承诺。", tip:"doubt 后常接 whether/if"},
  {q:"The teacher asked us _____ we had finished the assignment.", a:"whether", opts:["whether","that","what","how"], cn:"老师问我们是否完成了作业。", tip:"asked 后接 whether/if 表是否"},
  {q:"I know _____ you are thinking.", a:"what", opts:["what","that","which","whether"], cn:"我知道你在想什么。", tip:"what 引导宾语从句"},
  {q:"Could you tell me _____ this word means?", a:"what", opts:["what","that","which","whether"], cn:"你能告诉我这个词是什么意思吗？", tip:"what 引导宾语从句"},
  {q:"We should consider _____ to solve this problem.", a:"how", opts:["how","what","that","which"], cn:"我们应该考虑如何解决这个问题。", tip:"how + to do 引导宾语从句"},
  {q:"He forgot _____ he had put his keys.", a:"where", opts:["where","what","which","who"], cn:"他忘了把钥匙放哪了。", tip:"where 引导宾语从句"},
  {q:"She suggested _____ we should take a break.", a:"that", opts:["that","what","which","whether"], cn:"她建议我们应该休息一下。", tip:"suggest + that 引导宾语从句"},
  {q:"I hope _____ you have a safe trip.", a:"that", opts:["that","what","which","whether"], cn:"我希望你旅途平安。", tip:"hope + that 引导宾语从句"},
  {q:"He promised _____ he would never be late again.", a:"that", opts:["that","what","which","whether"], cn:"他保证再也不会迟到了。", tip:"promise + that 引导宾语从句"},
  {q:"She realized _____ she had made a mistake.", a:"that", opts:["that","what","which","whether"], cn:"她意识到自己犯了一个错误。", tip:"realize + that 引导宾语从句"},
  {q:"The doctor asked me _____ I felt.", a:"how", opts:["how","what","that","which"], cn:"医生问我感觉怎么样。", tip:"how 引导宾语从句"},
  {q:"I'm curious about _____ happened next.", a:"what", opts:["what","that","which","whether"], cn:"我很好奇接下来发生了什么。", tip:"what 引导介词宾语从句"},
  {q:"He insisted _____ we should go with him.", a:"that", opts:["that","what","which","whether"], cn:"他坚持让我们和他一起去。", tip:"insist + that 引导宾语从句"},
  {q:"She admitted _____ she was wrong.", a:"that", opts:["that","what","which","whether"], cn:"她承认她错了。", tip:"admit + that 引导宾语从句"},
  {q:"I noticed _____ he looked worried.", a:"that", opts:["that","what","which","whether"], cn:"我注意到他看起来很担忧。", tip:"notice + that 引导宾语从句"},
  {q:"He denied _____ he had stolen the money.", a:"that", opts:["that","what","which","whether"], cn:"他否认偷了钱。", tip:"deny + that 引导宾语从句"},
  {q:"I found _____ the task was more difficult than expected.", a:"that", opts:["that","what","which","whether"], cn:"我发现这项任务比预期的更难。", tip:"find + that 引导宾语从句"},
  {q:"She demanded _____ the manager speak to her.", a:"that", opts:["that","what","which","whether"], cn:"她要求经理跟她说话。", tip:"demand + that + (should) do 虚拟语气"},
  {q:"Can you guess _____ old she is?", a:"how", opts:["how","what","that","which"], cn:"你能猜到她多大吗？", tip:"how + adj. 引导宾语从句"},
  {q:"It depends on _____ the weather is like.", a:"what", opts:["what","that","which","whether"], cn:"这取决于天气怎么样。", tip:"depend on + what 引导介词宾语从句"},
  {q:"I appreciate _____ you have done for me.", a:"what", opts:["what","that","which","whether"], cn:"我感激你为我所做的一切。", tip:"what 引导宾语从句，= the things that"},
  {q:"He questioned _____ the plan would work.", a:"whether", opts:["whether","that","what","how"], cn:"他质疑这个计划是否可行。", tip:"question + whether 表是否"},
  {q:"She pretended _____ she didn't hear me.", a:"that", opts:["that","what","which","whether"], cn:"她假装没听到我说话。", tip:"pretend + that 引导宾语从句"},
  {q:"I regret _____ I didn't study harder.", a:"that", opts:["that","what","which","whether"], cn:"我后悔没有更努力学习。", tip:"regret + that 引导宾语从句"},
  {q:"He warned me _____ the road was dangerous.", a:"that", opts:["that","what","which","whether"], cn:"他警告我路很危险。", tip:"warn + that 引导宾语从句"},
  {q:"She guaranteed _____ the product was of high quality.", a:"that", opts:["that","what","which","whether"], cn:"她保证产品质量很高。", tip:"guarantee + that 引导宾语从句"},
  {q:"I'm afraid _____ I can't help you.", a:"that", opts:["that","what","which","whether"], cn:"恐怕我帮不了你。", tip:"I'm afraid + that 引导宾语从句"},
  {q:"He proved _____ the theory was correct.", a:"that", opts:["that","what","which","whether"], cn:"他证明了这个理论是正确的。", tip:"prove + that 引导宾语从句"},
  {q:"She discovered _____ her wallet was missing.", a:"that", opts:["that","what","which","whether"], cn:"她发现钱包不见了。", tip:"discover + that 引导宾语从句"},
  {q:"We agreed _____ it was time to move on.", a:"that", opts:["that","what","which","whether"], cn:"我们同意是时候继续前进了。", tip:"agree + that 引导宾语从句"},
  {q:"He confirmed _____ the meeting was at 3 pm.", a:"that", opts:["that","what","which","whether"], cn:"他确认会议在下午3点。", tip:"confirm + that 引导宾语从句"},
  {q:"She imagined _____ it would be like to live abroad.", a:"what", opts:["what","that","which","whether"], cn:"她想象住在国外会是什么样。", tip:"what 引导宾语从句"},
  {q:"I heard _____ they were getting married.", a:"that", opts:["that","what","which","whether"], cn:"我听说他们要结婚了。", tip:"hear + that 引导宾语从句"},
  {q:"He decided _____ he would apply for the job.", a:"that", opts:["that","what","which","whether"], cn:"他决定去申请这份工作。", tip:"decide + that 引导宾语从句"},
  {q:"She assumed _____ everyone knew the answer.", a:"that", opts:["that","what","which","whether"], cn:"她以为每个人都知道答案。", tip:"assume + that 引导宾语从句"},
  {q:"I expect _____ they will arrive on time.", a:"that", opts:["that","what","which","whether"], cn:"我期望他们会准时到达。", tip:"expect + that 引导宾语从句"},
  {q:"He predicted _____ the team would win.", a:"that", opts:["that","what","which","whether"], cn:"他预测这支队伍会赢。", tip:"predict + that 引导宾语从句"},
  {q:"Can you explain _____ this happened?", a:"how", opts:["how","what","that","which"], cn:"你能解释这是怎么发生的吗？", tip:"how 引导宾语从句"},
  {q:"I keep forgetting _____ I put my glasses.", a:"where", opts:["where","what","which","who"], cn:"我总是忘记把眼镜放在哪里了。", tip:"where 引导宾语从句"},
  {q:"She didn't mention _____ she was leaving.", a:"when", opts:["when","what","which","who"], cn:"她没提到她什么时候离开。", tip:"when 引导宾语从句"},

  // ── 主语从句 (50题) ──────────────────────────────────────
  {q:"_____ she said was very helpful.", a:"What", opts:["What","That","Which","How"], cn:"她说的话非常有帮助。", tip:"what 引导主语从句，what = the thing that"},
  {q:"_____ he will come is uncertain.", a:"Whether", opts:["Whether","What","That","How"], cn:"他是否会来还不确定。", tip:"whether 引导主语从句，表是否"},
  {q:"_____ is known to all is that the Earth is round.", a:"What", opts:["What","That","Which","How"], cn:"众所周知地球是圆的。", tip:"what 引导主语从句"},
  {q:"It is obvious _____ she is telling the truth.", a:"that", opts:["that","what","which","whether"], cn:"她在说实话，这很明显。", tip:"It is + adj. + that 主语从句"},
  {q:"_____ matters most is your health.", a:"What", opts:["What","That","Which","How"], cn:"最重要的是你的健康。", tip:"what 引导主语从句"},
  {q:"It is reported _____ the president will visit China.", a:"that", opts:["that","what","which","whether"], cn:"据报道总统将访问中国。", tip:"It is reported + that 主语从句"},
  {q:"_____ team wins the match will get the trophy.", a:"Whichever", opts:["Whichever","Whatever","However","Whenever"], cn:"无论哪个队赢了比赛都会获得奖杯。", tip:"whichever 引导主语从句，无论哪个"},
  {q:"It surprised me _____ he could speak five languages.", a:"that", opts:["that","what","which","whether"], cn:"他会说五种语言让我很惊讶。", tip:"It surprised sb. + that 主语从句"},
  {q:"_____ we need is more practice.", a:"What", opts:["What","That","Which","How"], cn:"我们需要的是更多的练习。", tip:"what 引导主语从句，what = the thing that"},
  {q:"It doesn't matter _____ you are rich or poor.", a:"whether", opts:["whether","that","what","how"], cn:"你是富是穷无所谓。", tip:"It doesn't matter + whether 主语从句"},
  {q:"_____ caused the accident is still unknown.", a:"What", opts:["What","That","Which","How"], cn:"事故的原因仍然不明。", tip:"what 引导主语从句，作主语"},
  {q:"It is said _____ he is the best doctor in town.", a:"that", opts:["that","what","which","whether"], cn:"据说他是镇上最好的医生。", tip:"It is said + that 主语从句"},
  {q:"_____ the Earth goes around the Sun is well known.", a:"That", opts:["That","What","Which","How"], cn:"地球绕太阳转是众所周知的。", tip:"that 引导主语从句，表已知事实"},
  {q:"It is suggested _____ we should start earlier.", a:"that", opts:["that","what","which","whether"], cn:"有人建议我们应该早点开始。", tip:"It is suggested + that + (should) do"},
  {q:"_____ you do affects your future.", a:"What", opts:["What","That","Which","How"], cn:"你所做的事影响你的未来。", tip:"what 引导主语从句"},
  {q:"It is important _____ students learn to think critically.", a:"that", opts:["that","what","which","whether"], cn:"学生学会批判性思维很重要。", tip:"It is important + that 主语从句"},
  {q:"_____ he said at the meeting shocked everyone.", a:"What", opts:["What","That","Which","How"], cn:"他在会上说的话让所有人都震惊了。", tip:"what 引导主语从句"},
  {q:"It is believed _____ exercise can improve mental health.", a:"that", opts:["that","what","which","whether"], cn:"人们相信锻炼能改善心理健康。", tip:"It is believed + that 主语从句"},
  {q:"_____ will attend the meeting hasn't been decided yet.", a:"Who", opts:["Who","What","That","Which"], cn:"谁参加会议还没有决定。", tip:"who 引导主语从句"},
  {q:"It remains to be seen _____ the plan will succeed.", a:"whether", opts:["whether","that","what","how"], cn:"这个计划能否成功还有待观察。", tip:"It remains to be seen + whether"},
  {q:"_____ surprised us was his sudden resignation.", a:"What", opts:["What","That","Which","How"], cn:"让我们惊讶的是他突然辞职了。", tip:"what 引导主语从句"},
  {q:"It is necessary _____ everyone follow the rules.", a:"that", opts:["that","what","which","whether"], cn:"每个人都遵守规则是必要的。", tip:"It is necessary + that + (should) do"},
  {q:"_____ you choose to do with your life is up to you.", a:"What", opts:["What","That","Which","How"], cn:"你选择如何过你的生活取决于你。", tip:"what 引导主语从句"},
  {q:"It is uncertain _____ the project will be completed on time.", a:"whether", opts:["whether","that","what","how"], cn:"项目能否按时完成还不确定。", tip:"It is uncertain + whether 主语从句"},
  {q:"_____ happens next depends on your decision.", a:"What", opts:["What","That","Which","How"], cn:"接下来发生什么取决于你的决定。", tip:"what 引导主语从句"},
  {q:"It is strange _____ he hasn't replied to my email.", a:"that", opts:["that","what","which","whether"], cn:"他没有回复我的邮件真奇怪。", tip:"It is strange + that 主语从句"},
  {q:"_____ makes him special is his positive attitude.", a:"What", opts:["What","That","Which","How"], cn:"使他与众不同的是他积极的态度。", tip:"what 引导主语从句"},
  {q:"It is a pity _____ you missed the concert.", a:"that", opts:["that","what","which","whether"], cn:"你错过了音乐会真可惜。", tip:"It is a pity + that 主语从句"},
  {q:"_____ he managed to escape remains a mystery.", a:"How", opts:["How","What","That","Which"], cn:"他是如何设法逃脱的仍是个谜。", tip:"how 引导主语从句"},
  {q:"It worried her _____ her son was still not home.", a:"that", opts:["that","what","which","whether"], cn:"儿子还没回家让她很担心。", tip:"It worried sb. + that 主语从句"},
  {q:"_____ she chose to forgive him moved everyone.", a:"That", opts:["That","What","Which","How"], cn:"她选择原谅他这件事感动了所有人。", tip:"that 引导主语从句，表事实"},
  {q:"It is clear _____ the company is making progress.", a:"that", opts:["that","what","which","whether"], cn:"很明显这家公司在进步。", tip:"It is clear + that 主语从句"},
  {q:"_____ the ancient Egyptians built the pyramids still amazes us.", a:"How", opts:["How","What","That","Which"], cn:"古埃及人如何建造金字塔至今令人惊叹。", tip:"how 引导主语从句"},
  {q:"It is not yet known _____ caused the fire.", a:"what", opts:["what","that","which","whether"], cn:"目前还不清楚是什么引起了火灾。", tip:"what 引导主语从句"},
  {q:"_____ we eat affects our health greatly.", a:"What", opts:["What","That","Which","How"], cn:"我们吃什么极大地影响着我们的健康。", tip:"what 引导主语从句"},
  {q:"It has been announced _____ the school will close for a week.", a:"that", opts:["that","what","which","whether"], cn:"已宣布学校将关闭一周。", tip:"It has been announced + that 主语从句"},
  {q:"_____ caught my attention was the beautiful painting.", a:"What", opts:["What","That","Which","How"], cn:"吸引我注意力的是那幅美丽的画。", tip:"what 引导主语从句"},
  {q:"It is doubtful _____ he can finish the work alone.", a:"whether", opts:["whether","that","what","how"], cn:"他能否独自完成这项工作值得怀疑。", tip:"It is doubtful + whether 主语从句"},
  {q:"_____ wins the race will get a prize.", a:"Whoever", opts:["Whoever","Whatever","Whichever","However"], cn:"无论谁赢得比赛都将获得奖品。", tip:"whoever 引导主语从句，无论谁"},
  {q:"It shocked us _____ the factory had closed down.", a:"that", opts:["that","what","which","whether"], cn:"工厂关闭了让我们很震惊。", tip:"It shocked sb. + that 主语从句"},
  {q:"_____ is done cannot be undone.", a:"What", opts:["What","That","Which","How"], cn:"木已成舟。（做过的事无法撤回。）", tip:"what 引导主语从句"},
  {q:"It occurred to me _____ I had left my phone at home.", a:"that", opts:["that","what","which","whether"], cn:"我突然想到我把手机落在家里了。", tip:"It occurred to sb. + that 主语从句"},
  {q:"_____ she survived the accident was a miracle.", a:"That", opts:["That","What","Which","How"], cn:"她在事故中幸存下来是个奇迹。", tip:"that 引导主语从句，表事实"},
  {q:"It is well known _____ smoking is harmful to health.", a:"that", opts:["that","what","which","whether"], cn:"众所周知吸烟有害健康。", tip:"It is well known + that 主语从句"},
  {q:"_____ the meeting will be held is still under discussion.", a:"Where", opts:["Where","What","That","Which"], cn:"会议在哪里举行仍在讨论中。", tip:"where 引导主语从句"},
  {q:"It is vital _____ we protect the environment.", a:"that", opts:["that","what","which","whether"], cn:"保护环境至关重要。", tip:"It is vital + that + (should) do"},
  {q:"_____ you believe in yourself is the first step to success.", a:"That", opts:["That","What","Which","How"], cn:"相信自己是成功的第一步。", tip:"that 引导主语从句"},
  {q:"It matters a lot _____ you treat others.", a:"how", opts:["how","what","that","which"], cn:"你如何对待他人很重要。", tip:"how 引导主语从句"},
  {q:"_____ impressed me most was her determination.", a:"What", opts:["What","That","Which","How"], cn:"最令我印象深刻的是她的决心。", tip:"what 引导主语从句"},
  {q:"It is estimated _____ over 2 million people attended.", a:"that", opts:["that","what","which","whether"], cn:"据估计超过200万人出席了。", tip:"It is estimated + that 主语从句"},

  // ── 表语从句 (40题) ──────────────────────────────────────
  {q:"The problem is _____ we don't have enough time.", a:"that", opts:["that","what","which","whether"], cn:"问题是我们没有足够的时间。", tip:"that 引导表语从句"},
  {q:"The question is _____ we should go or stay.", a:"whether", opts:["whether","that","what","how"], cn:"问题是我们应该走还是留。", tip:"whether 引导表语从句，表选择"},
  {q:"That is _____ I disagree with you.", a:"where", opts:["where","what","which","that"], cn:"那就是我不同意你的地方。", tip:"where 引导表语从句"},
  {q:"The reason he was late was _____ he missed the bus.", a:"that", opts:["that","because","why","what"], cn:"他迟到的原因是他错过了公交车。", tip:"The reason...is that... 不用because"},
  {q:"This is _____ the accident happened.", a:"where", opts:["where","what","which","that"], cn:"这就是事故发生的地方。", tip:"where 引导表语从句"},
  {q:"The fact is _____ we have already run out of money.", a:"that", opts:["that","what","which","whether"], cn:"事实是我们已经没钱了。", tip:"that 引导表语从句"},
  {q:"That is _____ he told me.", a:"what", opts:["what","that","which","whether"], cn:"那就是他告诉我的。", tip:"what 引导表语从句，what = the thing that"},
  {q:"My suggestion is _____ we should start earlier.", a:"that", opts:["that","what","which","whether"], cn:"我的建议是我们应该早点开始。", tip:"that 引导表语从句"},
  {q:"This is _____ I want to say.", a:"what", opts:["what","that","which","whether"], cn:"这就是我想说的。", tip:"what 引导表语从句"},
  {q:"The truth is _____ nobody really knows the answer.", a:"that", opts:["that","what","which","whether"], cn:"真相是没人真正知道答案。", tip:"that 引导表语从句"},
  {q:"That's _____ he got angry.", a:"why", opts:["why","what","which","that"], cn:"那就是他生气的原因。", tip:"why 引导表语从句"},
  {q:"It looks _____ it is going to rain.", a:"as if", opts:["as if","that","what","whether"], cn:"看起来好像要下雨了。", tip:"as if 引导表语从句"},
  {q:"The trouble is _____ I've lost his phone number.", a:"that", opts:["that","what","which","whether"], cn:"麻烦是我弄丢了他的电话号码。", tip:"that 引导表语从句"},
  {q:"That's _____ the problem lies.", a:"where", opts:["where","what","which","that"], cn:"那就是问题所在。", tip:"where 引导表语从句"},
  {q:"His wish is _____ he could travel around the world.", a:"that", opts:["that","what","which","whether"], cn:"他的愿望是能环游世界。", tip:"that 引导表语从句"},
  {q:"Life is _____ you make it.", a:"what", opts:["what","that","which","whether"], cn:"生活取决于你怎么过。", tip:"what 引导表语从句"},
  {q:"The result is _____ we won the competition.", a:"that", opts:["that","what","which","whether"], cn:"结果是我们赢了比赛。", tip:"that 引导表语从句"},
  {q:"It sounds _____ you had a great time.", a:"as if", opts:["as if","that","what","whether"], cn:"听起来你玩得很开心。", tip:"as if 引导表语从句"},
  {q:"My worry is _____ the weather might turn bad.", a:"that", opts:["that","what","which","whether"], cn:"我担心的是天气可能变坏。", tip:"that 引导表语从句"},
  {q:"That was _____ he failed the test.", a:"why", opts:["why","what","which","that"], cn:"那就是他考试不及格的原因。", tip:"why 引导表语从句"},
  {q:"The point is _____ we must take action now.", a:"that", opts:["that","what","which","whether"], cn:"关键是我们现在必须采取行动。", tip:"that 引导表语从句"},
  {q:"This is _____ he used to live.", a:"where", opts:["where","what","which","that"], cn:"这就是他以前住的地方。", tip:"where 引导表语从句"},
  {q:"His advice is _____ we should be more patient.", a:"that", opts:["that","what","which","whether"], cn:"他的建议是我们应该更有耐心。", tip:"that 引导表语从句"},
  {q:"The issue is _____ to solve the problem.", a:"how", opts:["how","what","that","which"], cn:"问题是如何解决这个问题。", tip:"how 引导表语从句"},
  {q:"It seems _____ he doesn't care about the result.", a:"as if", opts:["as if","that","what","whether"], cn:"看起来他不在乎结果。", tip:"as if 引导表语从句"},
  {q:"That is _____ she has been doing all day.", a:"what", opts:["what","that","which","whether"], cn:"那就是她一整天都在做的事。", tip:"what 引导表语从句"},
  {q:"The question remains _____ we should invest more money.", a:"whether", opts:["whether","that","what","how"], cn:"问题仍然是我们是否应该追加投资。", tip:"whether 引导表语从句"},
  {q:"My biggest concern is _____ the deadline might be moved up.", a:"that", opts:["that","what","which","whether"], cn:"我最大的担心是截止日期可能被提前。", tip:"that 引导表语从句"},
  {q:"That was _____ I learned the most.", a:"when", opts:["when","what","which","that"], cn:"那就是我学到最多的时候。", tip:"when 引导表语从句"},
  {q:"Her dream is _____ she can become a doctor.", a:"that", opts:["that","what","which","whether"], cn:"她的梦想是成为一名医生。", tip:"that 引导表语从句"},
  {q:"That is _____ caught my eye.", a:"what", opts:["what","that","which","whether"], cn:"那就是引起我注意的东西。", tip:"what 引导表语从句"},
  {q:"The danger is _____ we might lose everything.", a:"that", opts:["that","what","which","whether"], cn:"危险在于我们可能会失去一切。", tip:"that 引导表语从句"},
  {q:"It appears _____ the experiment has failed.", a:"that", opts:["that","what","which","whether"], cn:"看起来实验失败了。", tip:"It appears that 引导表语从句"},
  {q:"The advantage is _____ we can save a lot of time.", a:"that", opts:["that","what","which","whether"], cn:"优势在于我们能节省很多时间。", tip:"that 引导表语从句"},
  {q:"Her answer is _____ she needs more time to think.", a:"that", opts:["that","what","which","whether"], cn:"她的回答是她需要更多时间思考。", tip:"that 引导表语从句"},
  {q:"The challenge is _____ we finish before Friday.", a:"whether", opts:["whether","that","what","how"], cn:"挑战在于我们能否在周五前完成。", tip:"whether 引导表语从句"},
  {q:"This is _____ I've always wanted.", a:"what", opts:["what","that","which","whether"], cn:"这就是我一直想要的。", tip:"what 引导表语从句"},
  {q:"The key is _____ we must remain calm.", a:"that", opts:["that","what","which","whether"], cn:"关键是我们必须保持冷静。", tip:"that 引导表语从句"},
  {q:"That was _____ she became famous.", a:"how", opts:["how","what","which","that"], cn:"那就是她成名的方式。", tip:"how 引导表语从句"},
  {q:"His greatest fear is _____ he will be forgotten.", a:"that", opts:["that","what","which","whether"], cn:"他最大的恐惧是被人遗忘。", tip:"that 引导表语从句"},

  // ── 同位语从句 (50题) ──────────────────────────────────────
  {q:"The news _____ he had won the prize excited everyone.", a:"that", opts:["that","which","what","whether"], cn:"他获奖的消息让大家都很兴奋。", tip:"that 引导同位语从句，修饰news"},
  {q:"The fact _____ she was lying was obvious to all.", a:"that", opts:["that","which","what","whether"], cn:"她在撒谎这个事实对所有人来说都很明显。", tip:"that 引导同位语从句，修饰fact"},
  {q:"There is no doubt _____ we will succeed.", a:"that", opts:["that","which","what","whether"], cn:"毫无疑问我们会成功的。", tip:"that 引导同位语从句，修饰doubt"},
  {q:"The idea _____ we should hold a party was welcomed.", a:"that", opts:["that","which","what","whether"], cn:"我们应该办个派对的想法受到了欢迎。", tip:"that 引导同位语从句，修饰idea"},
  {q:"I have no idea _____ he is talking about.", a:"what", opts:["what","that","which","whether"], cn:"我不知道他在说什么。", tip:"what 引导同位语从句，修饰idea"},
  {q:"The belief _____ hard work leads to success is widespread.", a:"that", opts:["that","which","what","whether"], cn:"努力工作导致成功的信念很普遍。", tip:"that 引导同位语从句，修饰belief"},
  {q:"The question _____ we should go has not been answered.", a:"whether", opts:["whether","that","what","which"], cn:"我们是否应该去这个问题还没有回答。", tip:"whether 引导同位语从句，表是否"},
  {q:"He made a promise _____ he would never drink again.", a:"that", opts:["that","which","what","whether"], cn:"他承诺再也不喝酒了。", tip:"that 引导同位语从句，修饰promise"},
  {q:"The hope _____ he would return kept her going.", a:"that", opts:["that","which","what","whether"], cn:"他会回来的希望支撑着她。", tip:"that 引导同位语从句，修饰hope"},
  {q:"The possibility _____ it might rain worried us.", a:"that", opts:["that","which","what","whether"], cn:"可能会下雨这件事让我们担心。", tip:"that 引导同位语从句，修饰possibility"},
  {q:"The announcement _____ the school would close surprised everyone.", a:"that", opts:["that","which","what","whether"], cn:"学校要关闭的公告让大家都很惊讶。", tip:"that 引导同位语从句，修饰announcement"},
  {q:"She had a feeling _____ something bad was going to happen.", a:"that", opts:["that","which","what","whether"], cn:"她有一种感觉，要出事了。", tip:"that 引导同位语从句，修饰feeling"},
  {q:"The suggestion _____ we take a different approach was rejected.", a:"that", opts:["that","which","what","whether"], cn:"我们采取不同方法的建议被拒绝了。", tip:"that 引导同位语从句，修饰suggestion"},
  {q:"The rumor _____ the company would merge was confirmed.", a:"that", opts:["that","which","what","whether"], cn:"公司将合并的传言得到了证实。", tip:"that 引导同位语从句，修饰rumor"},
  {q:"The evidence _____ he was innocent was overwhelming.", a:"that", opts:["that","which","what","whether"], cn:"他无辜的证据是压倒性的。", tip:"that 引导同位语从句，修饰evidence"},
  {q:"The fear _____ she might fail kept her awake.", a:"that", opts:["that","which","what","whether"], cn:"她可能会失败的恐惧让她失眠。", tip:"that 引导同位语从句，修饰fear"},
  {q:"The decision _____ the project should be cancelled surprised us.", a:"that", opts:["that","which","what","whether"], cn:"项目应该被取消的决定让我们很惊讶。", tip:"that 引导同位语从句，修饰decision"},
  {q:"There is a chance _____ we might win the lottery.", a:"that", opts:["that","which","what","whether"], cn:"我们有可能中彩票。", tip:"that 引导同位语从句，修饰chance"},
  {q:"The demand _____ the workers be paid more was ignored.", a:"that", opts:["that","which","what","whether"], cn:"给工人加薪的要求被忽视了。", tip:"that 引导同位语从句，修饰demand，虚拟语气"},
  {q:"The warning _____ a storm was coming saved many lives.", a:"that", opts:["that","which","what","whether"], cn:"暴风雨即将来临的警告拯救了很多人。", tip:"that 引导同位语从句，修饰warning"},
  {q:"The question _____ he was guilty remained unanswered.", a:"whether", opts:["whether","that","what","which"], cn:"他是否有罪的问题仍未得到回答。", tip:"whether 引导同位语从句"},
  {q:"She expressed her wish _____ everyone would be happy.", a:"that", opts:["that","which","what","whether"], cn:"她表达了希望每个人都幸福的愿望。", tip:"that 引导同位语从句，修饰wish"},
  {q:"The thought _____ he might never see her again saddened him.", a:"that", opts:["that","which","what","whether"], cn:"他可能再也见不到她的想法让他很难过。", tip:"that 引导同位语从句，修饰thought"},
  {q:"The conclusion _____ the experiment was successful delighted the team.", a:"that", opts:["that","which","what","whether"], cn:"实验成功的结论让团队很高兴。", tip:"that 引导同位语从句，修饰conclusion"},
  {q:"The opinion _____ students should wear uniforms is debatable.", a:"that", opts:["that","which","what","whether"], cn:"学生应该穿校服的观点是有争议的。", tip:"that 引导同位语从句，修饰opinion"},
  {q:"He made an order _____ all employees must attend the meeting.", a:"that", opts:["that","which","what","whether"], cn:"他下令所有员工必须参加会议。", tip:"that 引导同位语从句，修饰order"},
  {q:"The assumption _____ everyone agreed was incorrect.", a:"that", opts:["that","which","what","whether"], cn:"所有人都同意这个假设是错误的。", tip:"that 引导同位语从句，修饰assumption"},
  {q:"His claim _____ he was at home all night was proven false.", a:"that", opts:["that","which","what","whether"], cn:"他声称自己整晚都在家被证明是假的。", tip:"that 引导同位语从句，修饰claim"},
  {q:"The proposal _____ a new park be built was approved.", a:"that", opts:["that","which","what","whether"], cn:"建设新公园的提议被批准了。", tip:"that 引导同位语从句，修饰proposal，虚拟语气"},
  {q:"The report _____ the river was polluted alarmed the residents.", a:"that", opts:["that","which","what","whether"], cn:"河流被污染的报告惊动了居民。", tip:"that 引导同位语从句，修饰report"},
  {q:"He couldn't shake off the feeling _____ he was being watched.", a:"that", opts:["that","which","what","whether"], cn:"他无法摆脱被人监视的感觉。", tip:"that 引导同位语从句，修饰feeling"},
  {q:"The theory _____ dinosaurs were killed by a meteor is widely accepted.", a:"that", opts:["that","which","what","whether"], cn:"恐龙被陨石灭绝的理论被广泛接受。", tip:"that 引导同位语从句，修饰theory"},
  {q:"Her determination _____ she would never give up inspired us.", a:"that", opts:["that","which","what","whether"], cn:"她决不放弃的决心激励了我们。", tip:"that 引导同位语从句，修饰determination"},
  {q:"The concern _____ the virus might spread quickly was justified.", a:"that", opts:["that","which","what","whether"], cn:"病毒可能快速传播的担忧是合理的。", tip:"that 引导同位语从句，修饰concern"},
  {q:"The principle _____ all people are equal is fundamental.", a:"that", opts:["that","which","what","whether"], cn:"人人平等的原则是根本性的。", tip:"that 引导同位语从句，修饰principle"},
  {q:"An agreement _____ both sides would compromise was reached.", a:"that", opts:["that","which","what","whether"], cn:"双方都会妥协的协议达成了。", tip:"that 引导同位语从句，修饰agreement"},
  {q:"The view _____ education is the key to success is widely held.", a:"that", opts:["that","which","what","whether"], cn:"教育是成功关键的观点被广泛持有。", tip:"that 引导同位语从句，修饰view"},
  {q:"His explanation _____ the delay was caused by traffic was acceptable.", a:"that", opts:["that","which","what","whether"], cn:"他解释延误是交通造成的，这是可以接受的。", tip:"that 引导同位语从句，修饰explanation"},
  {q:"The conviction _____ truth will prevail kept him fighting.", a:"that", opts:["that","which","what","whether"], cn:"真理终将胜利的信念让他不断战斗。", tip:"that 引导同位语从句，修饰conviction"},
  {q:"The mystery _____ the painting was stolen has never been solved.", a:"how", opts:["how","that","what","which"], cn:"这幅画是怎么被偷的至今未解。", tip:"how 引导同位语从句，修饰mystery"},
  {q:"The requirement _____ all applicants have a degree is strict.", a:"that", opts:["that","which","what","whether"], cn:"所有申请人必须有学位的要求很严格。", tip:"that 引导同位语从句，修饰requirement"},
  {q:"The insight _____ practice makes perfect changed his approach.", a:"that", opts:["that","which","what","whether"], cn:"熟能生巧的认识改变了他的方法。", tip:"that 引导同位语从句，修饰insight"},
  {q:"There is growing awareness _____ climate change is a serious threat.", a:"that", opts:["that","which","what","whether"], cn:"人们越来越意识到气候变化是严重的威胁。", tip:"that 引导同位语从句，修饰awareness"},
  {q:"The instruction _____ everyone should remain seated was clear.", a:"that", opts:["that","which","what","whether"], cn:"所有人保持就座的指示很明确。", tip:"that 引导同位语从句，修饰instruction"},
  {q:"She held the belief _____ kindness could change the world.", a:"that", opts:["that","which","what","whether"], cn:"她坚信善良能改变世界。", tip:"that 引导同位语从句，修饰belief"},
  {q:"The doubt _____ he could succeed troubled his parents.", a:"whether", opts:["whether","that","what","which"], cn:"他能否成功的疑虑困扰着他的父母。", tip:"whether 引导同位语从句，修饰doubt"},
  {q:"The request _____ we arrive early was reasonable.", a:"that", opts:["that","which","what","whether"], cn:"让我们早到的要求是合理的。", tip:"that 引导同位语从句，修饰request"},
  {q:"His argument _____ taxes should be lowered was convincing.", a:"that", opts:["that","which","what","whether"], cn:"他主张降低税收的论点很有说服力。", tip:"that 引导同位语从句，修饰argument"},
  {q:"The realization _____ time was running out motivated them.", a:"that", opts:["that","which","what","whether"], cn:"时间不多了的认识激励了他们。", tip:"that 引导同位语从句，修饰realization"},
  {q:"The likelihood _____ it will snow tonight is high.", a:"that", opts:["that","which","what","whether"], cn:"今晚下雪的可能性很高。", tip:"that 引导同位语从句，修饰likelihood"},
];

const ATTRIBUTIVE_QUESTIONS = [
  // ── who/whom/whose 修饰人 (35题) ──────────────────────────────────────
  {q:"The girl _____ is standing over there is my sister.", a:"who", opts:["who","which","whom","whose"], cn:"站在那边的女孩是我妹妹。", tip:"who 引导定语从句，修饰人，作主语"},
  {q:"The teacher _____ we met yesterday is very kind.", a:"whom", opts:["whom","who","which","whose"], cn:"我们昨天见到的那位老师非常和蔼。", tip:"whom 引导定语从句，修饰人，作宾语"},
  {q:"The boy _____ father is a doctor wants to be a nurse.", a:"whose", opts:["whose","who","whom","which"], cn:"父亲是医生的那个男孩想当护士。", tip:"whose 引导定语从句，表所属关系"},
  {q:"I know the man _____ you are talking about.", a:"whom", opts:["whom","who","which","whose"], cn:"我认识你在谈论的那个人。", tip:"whom 引导定语从句，作介词about的宾语"},
  {q:"Anyone _____ breaks the law will be punished.", a:"who", opts:["who","which","whom","whose"], cn:"任何违法的人都会受到惩罚。", tip:"who 引导定语从句，修饰不定代词anyone"},
  {q:"The woman _____ bag was stolen reported to the police.", a:"whose", opts:["whose","who","whom","which"], cn:"包被偷的那个女人报了警。", tip:"whose 引导定语从句，表所属"},
  {q:"He is the man _____ I told you about.", a:"whom", opts:["whom","who","which","whose"], cn:"他就是我跟你提到的那个人。", tip:"whom 引导定语从句，作介词about的宾语"},
  {q:"The students _____ passed the exam were very happy.", a:"who", opts:["who","which","whom","whose"], cn:"通过考试的学生们非常高兴。", tip:"who 引导定语从句，作主语"},
  {q:"She married a man _____ she met on a trip.", a:"whom", opts:["whom","who","which","whose"], cn:"她嫁给了一个旅行中认识的人。", tip:"whom 引导定语从句，作宾语"},
  {q:"The player _____ scored the winning goal celebrated wildly.", a:"who", opts:["who","which","whom","whose"], cn:"进了制胜球的球员疯狂庆祝。", tip:"who 引导定语从句，修饰人，作主语"},
  {q:"The lady _____ house we visited was very hospitable.", a:"whose", opts:["whose","who","whom","which"], cn:"我们参观了她家的那位女士非常好客。", tip:"whose 引导定语从句，表所属"},
  {q:"Those _____ wish to leave may do so now.", a:"who", opts:["who","which","whom","whose"], cn:"想离开的人现在可以走了。", tip:"who 修饰those，作主语"},
  {q:"The actor _____ played the villain was incredible.", a:"who", opts:["who","which","whom","whose"], cn:"演反派的那个演员太厉害了。", tip:"who 引导定语从句，修饰人，作主语"},
  {q:"She is the author _____ books I love to read.", a:"whose", opts:["whose","who","whom","which"], cn:"她是那个我喜欢读她的书的作家。", tip:"whose 引导定语从句，表所属"},
  {q:"The person _____ you should contact is Mr. Wang.", a:"whom", opts:["whom","who","which","whose"], cn:"你应该联系的人是王先生。", tip:"whom 引导定语从句，作宾语"},
  {q:"The children _____ parents work abroad live with their grandparents.", a:"whose", opts:["whose","who","whom","which"], cn:"父母在国外工作的孩子和祖父母住。", tip:"whose 引导定语从句，表所属"},
  {q:"He is someone _____ everyone respects.", a:"whom", opts:["whom","who","which","whose"], cn:"他是每个人都尊敬的人。", tip:"whom 引导定语从句，作宾语"},
  {q:"Is there anyone _____ can help me with this?", a:"who", opts:["who","which","whom","whose"], cn:"有人能帮我吗？", tip:"who 修饰不定代词anyone"},
  {q:"The musician _____ performance was outstanding received a standing ovation.", a:"whose", opts:["whose","who","whom","which"], cn:"表演出色的那位音乐家获得了全场起立鼓掌。", tip:"whose 引导定语从句，表所属"},
  {q:"He was the only person _____ understood the problem.", a:"who", opts:["who","which","whom","whose"], cn:"他是唯一理解这个问题的人。", tip:"the only 修饰先行词时用who/that"},
  {q:"The woman to _____ I spoke was very helpful.", a:"whom", opts:["whom","who","which","whose"], cn:"跟我说话的那位女士非常乐于助人。", tip:"介词 + whom 引导定语从句"},
  {q:"The doctor _____ treated my father is retiring next month.", a:"who", opts:["who","which","whom","whose"], cn:"给我父亲看病的那位医生下个月就退休了。", tip:"who 引导定语从句，作主语"},
  {q:"A person _____ word you can trust is a true friend.", a:"whose", opts:["whose","who","whom","which"], cn:"一个你能信赖其话的人是真正的朋友。", tip:"whose word 表所属"},
  {q:"The writer _____ novel won the award gave a speech.", a:"whose", opts:["whose","who","whom","which"], cn:"小说获奖的那位作家发表了演讲。", tip:"whose 引导定语从句，表所属"},
  {q:"All _____ heard the news were shocked.", a:"who", opts:["who","which","whom","whose"], cn:"所有听到消息的人都震惊了。", tip:"who 修饰all，作主语"},
  {q:"The friend with _____ I grew up has moved to London.", a:"whom", opts:["whom","who","which","whose"], cn:"和我一起长大的朋友搬到伦敦了。", tip:"介词 + whom 引导定语从句"},
  {q:"The customer _____ complaint was handled quickly left satisfied.", a:"whose", opts:["whose","who","whom","which"], cn:"投诉被迅速处理的那位顾客满意地离开了。", tip:"whose 引导定语从句，表所属"},
  {q:"She is not the kind of person _____ would lie.", a:"who", opts:["who","which","whom","whose"], cn:"她不是那种会撒谎的人。", tip:"who 引导定语从句，修饰person"},
  {q:"The pilot _____ safely landed the plane was praised by all.", a:"who", opts:["who","which","whom","whose"], cn:"安全着陆飞机的飞行员受到了大家的赞扬。", tip:"who 引导定语从句，作主语"},
  {q:"The scientist _____ research changed the world received the Nobel Prize.", a:"whose", opts:["whose","who","whom","which"], cn:"研究改变了世界的那位科学家获得了诺贝尔奖。", tip:"whose 引导定语从句，表所属"},
  {q:"He is a colleague _____ I greatly admire.", a:"whom", opts:["whom","who","which","whose"], cn:"他是我非常敬佩的同事。", tip:"whom 引导定语从句，作宾语"},
  {q:"The people _____ live next door are very friendly.", a:"who", opts:["who","which","whom","whose"], cn:"住在隔壁的人非常友好。", tip:"who 引导定语从句，修饰人，作主语"},
  {q:"The singer _____ voice is amazing won the competition.", a:"whose", opts:["whose","who","whom","which"], cn:"声音很棒的那位歌手赢了比赛。", tip:"whose 引导定语从句，表所属"},
  {q:"The man _____ she is engaged to is a lawyer.", a:"whom", opts:["whom","who","which","whose"], cn:"她订婚的那个人是律师。", tip:"whom 引导定语从句，作介词to的宾语"},
  {q:"The volunteers _____ helped during the flood are heroes.", a:"who", opts:["who","which","whom","whose"], cn:"在洪水期间帮忙的志愿者们是英雄。", tip:"who 引导定语从句，修饰人，作主语"},

  // ── which 修饰物 (30题) ──────────────────────────────────────
  {q:"The book _____ I borrowed from the library was very interesting.", a:"which", opts:["which","who","whom","whose"], cn:"我从图书馆借的那本书很有趣。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The car _____ is parked outside belongs to my neighbor.", a:"which", opts:["which","who","whom","whose"], cn:"停在外面的那辆车是我邻居的。", tip:"which 引导定语从句，修饰物，作主语"},
  {q:"The movie _____ we watched last night was amazing.", a:"which", opts:["which","who","whom","whose"], cn:"我们昨晚看的那部电影太棒了。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The building _____ was built in 1900 has been renovated.", a:"which", opts:["which","who","whom","whose"], cn:"建于1900年的那栋建筑已经翻新了。", tip:"which 引导定语从句，修饰物，作主语"},
  {q:"She gave me a gift _____ I really love.", a:"which", opts:["which","who","whom","whose"], cn:"她给了我一个我非常喜欢的礼物。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The hotel in _____ we stayed was very comfortable.", a:"which", opts:["which","who","whom","whose"], cn:"我们住的那家酒店非常舒适。", tip:"介词 + which 引导定语从句"},
  {q:"The letter _____ arrived this morning is from my uncle.", a:"which", opts:["which","who","whom","whose"], cn:"今天早上到的那封信是我叔叔寄来的。", tip:"which 引导定语从句，修饰物，作主语"},
  {q:"The city in _____ I was born is very beautiful.", a:"which", opts:["which","who","whom","whose"], cn:"我出生的那座城市非常美丽。", tip:"介词 + which 引导定语从句"},
  {q:"The cake _____ she made was delicious.", a:"which", opts:["which","who","whom","whose"], cn:"她做的蛋糕很好吃。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The tool with _____ he fixed the machine was a wrench.", a:"which", opts:["which","who","whom","whose"], cn:"他修机器用的工具是一把扳手。", tip:"介词 + which 引导定语从句"},
  {q:"The bridge _____ collapsed last year has been rebuilt.", a:"which", opts:["which","who","whom","whose"], cn:"去年倒塌的那座桥已经重建了。", tip:"which 引导定语从句，作主语"},
  {q:"The song _____ she sang touched everyone's heart.", a:"which", opts:["which","who","whom","whose"], cn:"她唱的那首歌触动了每个人的心。", tip:"which 引导定语从句，作宾语"},
  {q:"The painting on _____ he spent months was finally completed.", a:"which", opts:["which","who","whom","whose"], cn:"他花了几个月的那幅画终于完成了。", tip:"介词 + which 引导定语从句"},
  {q:"The company for _____ she works is well-known.", a:"which", opts:["which","who","whom","whose"], cn:"她工作的那家公司很有名。", tip:"介词 + which 引导定语从句"},
  {q:"The exam _____ we took yesterday was really hard.", a:"which", opts:["which","who","whom","whose"], cn:"我们昨天考的那场试真的很难。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The school at _____ he studied is one of the best.", a:"which", opts:["which","who","whom","whose"], cn:"他上的那所学校是最好的之一。", tip:"介词 + which 引导定语从句"},
  {q:"The flowers _____ grow in the garden are beautiful.", a:"which", opts:["which","who","whom","whose"], cn:"花园里长的花很美。", tip:"which 引导定语从句，作主语"},
  {q:"The house _____ roof was damaged in the storm needs repair.", a:"whose", opts:["whose","which","who","whom"], cn:"屋顶在暴风雨中受损的那栋房子需要维修。", tip:"whose 可修饰物，表所属"},
  {q:"The phone _____ I bought last week has already broken.", a:"which", opts:["which","who","whom","whose"], cn:"我上周买的手机已经坏了。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"This is the reason for _____ he was late.", a:"which", opts:["which","who","whom","whose"], cn:"这就是他迟到的原因。", tip:"for which = why 引导定语从句"},
  {q:"The factory _____ produces toys has closed down.", a:"which", opts:["which","who","whom","whose"], cn:"生产玩具的那家工厂倒闭了。", tip:"which 引导定语从句，作主语"},
  {q:"The chair on _____ you are sitting is broken.", a:"which", opts:["which","who","whom","whose"], cn:"你坐的那把椅子坏了。", tip:"介词 + which 引导定语从句"},
  {q:"The problem _____ we need to solve is very complex.", a:"which", opts:["which","who","whom","whose"], cn:"我们需要解决的问题非常复杂。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The machine _____ he invented has saved many lives.", a:"which", opts:["which","who","whom","whose"], cn:"他发明的那台机器拯救了很多生命。", tip:"which 引导定语从句，作宾语"},
  {q:"The mountain from the top of _____ you can see the ocean is very high.", a:"which", opts:["which","who","whom","whose"], cn:"从山顶能看到海洋的那座山很高。", tip:"介词短语 + which 引导定语从句"},
  {q:"The dress _____ she wore to the party was stunning.", a:"which", opts:["which","who","whom","whose"], cn:"她穿去派对的那条裙子太惊艳了。", tip:"which 引导定语从句，修饰物，作宾语"},
  {q:"The library _____ has over a million books is open daily.", a:"which", opts:["which","who","whom","whose"], cn:"拥有一百多万册书的图书馆每天开放。", tip:"which 引导定语从句，作主语"},
  {q:"The key without _____ you can't open the door is on the table.", a:"which", opts:["which","who","whom","whose"], cn:"没有它就打不开门的那把钥匙在桌上。", tip:"without which 介词 + which"},
  {q:"The method by _____ he solved the problem was clever.", a:"which", opts:["which","who","whom","whose"], cn:"他解决问题的方法很巧妙。", tip:"by which 介词 + which"},
  {q:"The street _____ leads to the park is lined with trees.", a:"which", opts:["which","who","whom","whose"], cn:"通往公园的那条街两旁种满了树。", tip:"which 引导定语从句，作主语"},

  // ── that 的特殊用法 (25题) ──────────────────────────────────────
  {q:"He is the best student _____ I have ever taught.", a:"that", opts:["that","which","who","whom"], cn:"他是我教过的最好的学生。", tip:"先行词有最高级修饰时用that"},
  {q:"This is the first letter _____ I've received.", a:"that", opts:["that","which","who","whom"], cn:"这是我收到的第一封信。", tip:"先行词有序数词修饰时用that"},
  {q:"All _____ glitters is not gold.", a:"that", opts:["that","which","who","whom"], cn:"发光的不一定是金子。", tip:"先行词是all/everything等不定代词时用that"},
  {q:"Everything _____ he said was true.", a:"that", opts:["that","which","who","whom"], cn:"他说的每一句话都是真的。", tip:"先行词是everything时用that"},
  {q:"The last thing _____ I want is to hurt you.", a:"that", opts:["that","which","who","whom"], cn:"我最不想做的就是伤害你。", tip:"先行词有the last修饰时用that"},
  {q:"Is there anything _____ I can do for you?", a:"that", opts:["that","which","who","whom"], cn:"有什么我能帮你的吗？", tip:"先行词是anything时用that"},
  {q:"This is the very book _____ I've been looking for.", a:"that", opts:["that","which","who","whom"], cn:"这正是我一直在找的那本书。", tip:"先行词有the very修饰时用that"},
  {q:"Nothing _____ you say can change my mind.", a:"that", opts:["that","which","who","whom"], cn:"你说什么都改变不了我的想法。", tip:"先行词是nothing时用that"},
  {q:"The only thing _____ matters is your happiness.", a:"that", opts:["that","which","who","whom"], cn:"唯一重要的是你的幸福。", tip:"先行词有the only修饰时用that"},
  {q:"He talked about the people and places _____ he had visited.", a:"that", opts:["that","which","who","whom"], cn:"他谈到了他去过的人和地方。", tip:"先行词既有人又有物时用that"},
  {q:"Who is the girl _____ is singing on the stage?", a:"that", opts:["that","which","who","whom"], cn:"在台上唱歌的女孩是谁？", tip:"先行词被who修饰时用that避免重复"},
  {q:"Any student _____ is late will be marked absent.", a:"that", opts:["that","which","who","whom"], cn:"任何迟到的学生都会被标记缺勤。", tip:"先行词有any修饰时用that"},
  {q:"This is the most beautiful city _____ I have ever seen.", a:"that", opts:["that","which","who","whom"], cn:"这是我见过的最美的城市。", tip:"先行词有最高级修饰时用that"},
  {q:"There is nothing _____ can stop us now.", a:"that", opts:["that","which","who","whom"], cn:"现在没有什么能阻止我们。", tip:"先行词是nothing时用that"},
  {q:"He is the tallest man _____ I have ever met.", a:"that", opts:["that","which","who","whom"], cn:"他是我见过的最高的人。", tip:"先行词有最高级修饰时用that"},
  {q:"The first thing _____ you should do is apologize.", a:"that", opts:["that","which","who","whom"], cn:"你应该做的第一件事是道歉。", tip:"先行词有序数词修饰时用that"},
  {q:"All the books _____ you need are on the shelf.", a:"that", opts:["that","which","who","whom"], cn:"你需要的所有书都在架子上。", tip:"先行词是all修饰时用that"},
  {q:"Much _____ he said was nonsense.", a:"that", opts:["that","which","who","whom"], cn:"他说的很多话都是胡说八道。", tip:"先行词是much时用that"},
  {q:"Everything _____ happens has a reason.", a:"that", opts:["that","which","who","whom"], cn:"发生的每件事都有原因。", tip:"先行词是everything时用that"},
  {q:"The second time _____ I met her was at a party.", a:"that", opts:["that","which","who","whom"], cn:"我第二次见到她是在一个派对上。", tip:"先行词有序数词修饰时用that"},
  {q:"He showed me all _____ he had bought.", a:"that", opts:["that","which","who","whom"], cn:"他给我看了他买的所有东西。", tip:"先行词是all时用that"},
  {q:"This is the same pen _____ I lost yesterday.", a:"that", opts:["that","which","who","whom"], cn:"这就是我昨天丢的那支笔。(同一支)", tip:"the same...that 同一个(指同一物)"},
  {q:"Who _____ has common sense would do such a thing?", a:"that", opts:["that","which","who","whom"], cn:"有常识的人谁会做这种事？", tip:"先行词被who修饰时用that"},
  {q:"It is the most difficult exam _____ we have ever taken.", a:"that", opts:["that","which","who","whom"], cn:"这是我们考过的最难的考试。", tip:"先行词有最高级修饰时用that"},
  {q:"She is the only person _____ can solve this problem.", a:"that", opts:["that","which","who","whom"], cn:"她是唯一能解决这个问题的人。", tip:"先行词有the only修饰时用that"},

  // ── where/when/why (30题) ──────────────────────────────────────
  {q:"This is the place _____ we first met.", a:"where", opts:["where","which","when","why"], cn:"这是我们第一次见面的地方。", tip:"where 引导定语从句，修饰地点名词"},
  {q:"I remember the day _____ I graduated from college.", a:"when", opts:["when","where","which","why"], cn:"我记得大学毕业的那天。", tip:"when 引导定语从句，修饰时间名词"},
  {q:"That is the reason _____ I was late.", a:"why", opts:["why","where","when","which"], cn:"那就是我迟到的原因。", tip:"why 引导定语从句，修饰reason"},
  {q:"The restaurant _____ we had dinner was excellent.", a:"where", opts:["where","which","when","why"], cn:"我们吃晚饭的那家餐厅非常棒。", tip:"where 引导定语从句，修饰地点名词"},
  {q:"Do you remember the time _____ we got lost in the forest?", a:"when", opts:["when","where","which","why"], cn:"你还记得我们在森林里迷路的那次吗？", tip:"when 引导定语从句，修饰time"},
  {q:"The hotel _____ we stayed was near the beach.", a:"where", opts:["where","which","when","why"], cn:"我们住的那家酒店在海边附近。", tip:"where 引导定语从句，修饰地点"},
  {q:"That was the year _____ the war broke out.", a:"when", opts:["when","where","which","why"], cn:"那是战争爆发的那一年。", tip:"when 引导定语从句，修饰year"},
  {q:"Is there any reason _____ you should be excused?", a:"why", opts:["why","where","when","which"], cn:"有什么理由你应该被原谅吗？", tip:"why 引导定语从句，修饰reason"},
  {q:"The village _____ I grew up has changed a lot.", a:"where", opts:["where","which","when","why"], cn:"我长大的那个村庄变化了很多。", tip:"where 引导定语从句，修饰地点"},
  {q:"She will never forget the moment _____ she won the prize.", a:"when", opts:["when","where","which","why"], cn:"她永远不会忘记获奖的那一刻。", tip:"when 引导定语从句，修饰moment"},
  {q:"I don't know the reason _____ he left so suddenly.", a:"why", opts:["why","where","when","which"], cn:"我不知道他突然离开的原因。", tip:"why 引导定语从句，修饰reason"},
  {q:"The park _____ children often play is being renovated.", a:"where", opts:["where","which","when","why"], cn:"孩子们经常玩耍的公园正在翻新。", tip:"where 引导定语从句，修饰地点"},
  {q:"I remember the summer _____ we traveled to Europe.", a:"when", opts:["when","where","which","why"], cn:"我记得我们去欧洲旅行的那个夏天。", tip:"when 引导定语从句，修饰时间"},
  {q:"The office _____ she works is on the tenth floor.", a:"where", opts:["where","which","when","why"], cn:"她工作的办公室在十楼。", tip:"where 引导定语从句，修饰地点"},
  {q:"There must be a reason _____ he didn't come.", a:"why", opts:["why","where","when","which"], cn:"他没来一定有原因。", tip:"why 引导定语从句，修饰reason"},
  {q:"The hospital _____ my mother works is very large.", a:"where", opts:["where","which","when","why"], cn:"我妈妈工作的那家医院很大。", tip:"where 引导定语从句，修饰地点"},
  {q:"The era _____ dinosaurs lived is called the Mesozoic.", a:"when", opts:["when","where","which","why"], cn:"恐龙生活的时代叫做中生代。", tip:"when 引导定语从句，修饰时间"},
  {q:"This is the classroom _____ we have English lessons.", a:"where", opts:["where","which","when","why"], cn:"这是我们上英语课的教室。", tip:"where 引导定语从句，修饰地点"},
  {q:"That was the occasion _____ he proposed to her.", a:"when", opts:["when","where","which","why"], cn:"那就是他向她求婚的场合。", tip:"when 引导定语从句，修饰occasion"},
  {q:"The country _____ he was born is very small.", a:"where", opts:["where","which","when","why"], cn:"他出生的那个国家很小。", tip:"where 引导定语从句，修饰地点"},
  {q:"I still recall the afternoon _____ we sat by the river.", a:"when", opts:["when","where","which","why"], cn:"我还记得我们坐在河边的那个下午。", tip:"when 引导定语从句，修饰时间"},
  {q:"The shop _____ I bought this bag has closed.", a:"where", opts:["where","which","when","why"], cn:"我买这个包的那家店关了。", tip:"where 引导定语从句，修饰地点"},
  {q:"That was the season _____ everything started to change.", a:"when", opts:["when","where","which","why"], cn:"那是一切开始改变的季节。", tip:"when 引导定语从句，修饰season"},
  {q:"The farm _____ we picked strawberries was fun.", a:"where", opts:["where","which","when","why"], cn:"我们摘草莓的那个农场很有趣。", tip:"where 引导定语从句，修饰地点"},
  {q:"The reason _____ he quit his job was personal.", a:"why", opts:["why","where","when","which"], cn:"他辞职的原因是私人的。", tip:"why 引导定语从句，修饰reason"},
  {q:"Can you tell me the reason _____ you were absent?", a:"why", opts:["why","where","when","which"], cn:"你能告诉我你缺席的原因吗？", tip:"why 引导定语从句，修饰reason"},
  {q:"The museum _____ the exhibition is held is downtown.", a:"where", opts:["where","which","when","why"], cn:"举办展览的博物馆在市中心。", tip:"where 引导定语从句，修饰地点"},
  {q:"I'll never forget the night _____ we watched the meteor shower.", a:"when", opts:["when","where","which","why"], cn:"我永远不会忘记我们看流星雨的那个晚上。", tip:"when 引导定语从句，修饰night"},
  {q:"This is the school _____ Lu Xun once studied.", a:"where", opts:["where","which","when","why"], cn:"这就是鲁迅曾经就读的学校。", tip:"where 引导定语从句，修饰地点"},
  {q:"The morning _____ we left was cold and foggy.", a:"when", opts:["when","where","which","why"], cn:"我们离开的那个早上又冷又有雾。", tip:"when 引导定语从句，修饰morning"},

  // ── 非限定性定语从句 (30题) ──────────────────────────────────────
  {q:"My sister, _____ lives in Beijing, is a teacher.", a:"who", opts:["who","that","which","whom"], cn:"我姐姐住在北京，是一名老师。", tip:"非限定性定语从句用who不用that，有逗号"},
  {q:"The Great Wall, _____ is one of the wonders of the world, attracts millions of visitors.", a:"which", opts:["which","that","who","whom"], cn:"长城是世界奇迹之一，吸引了数百万游客。", tip:"非限定性定语从句用which不用that"},
  {q:"He gave me a book, _____ I found very useful.", a:"which", opts:["which","that","who","whom"], cn:"他给了我一本书，我觉得非常有用。", tip:"非限定性定语从句用which，不用that"},
  {q:"Tom, _____ mother is a nurse, wants to study medicine.", a:"whose", opts:["whose","who","which","that"], cn:"汤姆的妈妈是护士，他想学医。", tip:"whose 在非限定性定语从句中表所属"},
  {q:"She married John, _____ she had known since childhood.", a:"whom", opts:["whom","who","which","that"], cn:"她嫁给了约翰，她从小就认识他。", tip:"非限定性定语从句用whom作宾语"},
  {q:"We visited Paris, _____ is the capital of France.", a:"which", opts:["which","that","who","whom"], cn:"我们参观了巴黎，它是法国的首都。", tip:"非限定性定语从句用which修饰地名"},
  {q:"He passed the exam, _____ made his parents very happy.", a:"which", opts:["which","that","who","whom"], cn:"他通过了考试，这让他的父母非常高兴。", tip:"which 指代前面整个句子"},
  {q:"My neighbor, _____ dog always barks at night, has moved away.", a:"whose", opts:["whose","who","which","that"], cn:"我的邻居搬走了，他家的狗总在晚上叫。", tip:"whose 在非限定性定语从句中表所属"},
  {q:"The professor, _____ we all respect, retired last year.", a:"whom", opts:["whom","who","which","that"], cn:"那位我们都尊敬的教授去年退休了。", tip:"非限定性定语从句用whom作宾语"},
  {q:"She won the gold medal, _____ was a great achievement.", a:"which", opts:["which","that","who","whom"], cn:"她赢得了金牌，这是一项伟大的成就。", tip:"which 指代前面整个事件"},
  {q:"Dr. Smith, _____ specializes in heart surgery, saved the patient.", a:"who", opts:["who","that","which","whom"], cn:"史密斯医生专攻心脏手术，他救了那个病人。", tip:"非限定性定语从句用who"},
  {q:"The Nile, _____ is the longest river in Africa, flows through Egypt.", a:"which", opts:["which","that","who","whom"], cn:"尼罗河是非洲最长的河流，流经埃及。", tip:"非限定性定语从句用which"},
  {q:"He was late again, _____ annoyed the teacher.", a:"which", opts:["which","that","who","whom"], cn:"他又迟到了，这让老师很恼火。", tip:"which 指代前面整个事件"},
  {q:"My uncle, _____ I haven't seen for years, came to visit us.", a:"whom", opts:["whom","who","which","that"], cn:"我多年未见的叔叔来看我们了。", tip:"非限定性定语从句用whom作宾语"},
  {q:"The Amazon, _____ is in South America, is a huge rainforest.", a:"which", opts:["which","that","who","whom"], cn:"亚马逊在南美洲，是一片巨大的热带雨林。", tip:"非限定性定语从句用which"},
  {q:"She refused the offer, _____ surprised everyone.", a:"which", opts:["which","that","who","whom"], cn:"她拒绝了这个提议，这让所有人都很惊讶。", tip:"which 指代前面整个句子"},
  {q:"Mr. Li, _____ daughter is my classmate, is a pilot.", a:"whose", opts:["whose","who","which","that"], cn:"李先生的女儿是我同学，他是一名飞行员。", tip:"whose 在非限定性定语从句中表所属"},
  {q:"He quit his job, _____ was a brave decision.", a:"which", opts:["which","that","who","whom"], cn:"他辞了职，这是一个勇敢的决定。", tip:"which 指代前面整个事件"},
  {q:"The meeting, _____ lasted two hours, ended at 5 pm.", a:"which", opts:["which","that","who","whom"], cn:"会议持续了两个小时，下午5点结束。", tip:"非限定性定语从句用which"},
  {q:"Einstein, _____ was born in Germany, developed the theory of relativity.", a:"who", opts:["who","that","which","whom"], cn:"爱因斯坦出生在德国，他提出了相对论。", tip:"非限定性定语从句用who修饰人名"},
  {q:"She apologized to me, _____ I thought was unnecessary.", a:"which", opts:["which","that","who","whom"], cn:"她向我道歉了，我觉得没有必要。", tip:"which 指代前面整个事件"},
  {q:"The town, _____ population is only 5000, is very peaceful.", a:"whose", opts:["whose","who","which","that"], cn:"这个小镇人口只有5000，非常宁静。", tip:"whose 修饰物，表所属，非限定性从句"},
  {q:"They lost the game, _____ was disappointing.", a:"which", opts:["which","that","who","whom"], cn:"他们输了比赛，这很令人失望。", tip:"which 指代前面整个事件"},
  {q:"Beijing, _____ has a history of over 3000 years, is China's capital.", a:"which", opts:["which","that","who","whom"], cn:"北京有三千多年的历史，是中国的首都。", tip:"非限定性定语从句用which"},
  {q:"He donated a million dollars, _____ was very generous of him.", a:"which", opts:["which","that","who","whom"], cn:"他捐了一百万美元，他真的很慷慨。", tip:"which 指代前面整个事件"},
  {q:"The film, _____ I've seen three times, never gets boring.", a:"which", opts:["which","that","who","whom"], cn:"这部电影我看了三遍，从不觉得无聊。", tip:"非限定性定语从句用which作宾语"},
  {q:"She was elected president, _____ nobody had expected.", a:"which", opts:["which","that","who","whom"], cn:"她当选了总统，这是谁也没想到的。", tip:"which 指代前面整个事件"},
  {q:"The Thames, _____ flows through London, is famous worldwide.", a:"which", opts:["which","that","who","whom"], cn:"泰晤士河流经伦敦，世界闻名。", tip:"非限定性定语从句用which修饰河流名"},
  {q:"He worked all night, _____ is why he looks so tired.", a:"which", opts:["which","that","who","whom"], cn:"他工作了整晚，这就是他看起来这么累的原因。", tip:"which 指代前面整个事件"},
  {q:"My birthday, _____ falls on a Saturday this year, will be celebrated at home.", a:"which", opts:["which","that","who","whom"], cn:"我的生日今年在周六，将在家里庆祝。", tip:"非限定性定语从句用which"},

  // ── 易混淆辨析题 (50题) ──────────────────────────────────────
  {q:"The reason _____ he was absent was that he was ill.", a:"why", opts:["why","which","that","for which"], cn:"他缺席的原因是他生病了。", tip:"why 修饰reason，= for which"},
  {q:"I'll never forget the day _____ I met you.", a:"when", opts:["when","which","that","on which"], cn:"我永远不会忘记我遇见你的那天。", tip:"when 修饰day，= on which"},
  {q:"The way _____ he speaks is very interesting.", a:"in which", opts:["in which","which","why","where"], cn:"他说话的方式很有趣。", tip:"the way + in which/that/省略，不用how"},
  {q:"He is one of the students who _____ good at math.", a:"are", opts:["are","is","was","were"], cn:"他是擅长数学的学生之一。", tip:"one of + 复数名词 + who + 复数动词"},
  {q:"He is the only one of the students who _____ good at math.", a:"is", opts:["is","are","was","were"], cn:"他是唯一一个擅长数学的学生。", tip:"the only one of + 复数名词 + who + 单数动词"},
  {q:"The news _____ he told me was shocking. (同位语从句 or 定语从句?)", a:"that (定)", opts:["that (定)","that (同)","which","what"], cn:"他告诉我的那个消息令人震惊。（定语从句，that作宾语）", tip:"that在从句中作told的宾语→定语从句"},
  {q:"The news _____ he had passed the exam was exciting. (同位语从句 or 定语从句?)", a:"that (同)", opts:["that (同)","that (定)","which","what"], cn:"他通过了考试的消息令人兴奋。（同位语从句，that不作成分）", tip:"that在从句中不作成分→同位语从句"},
  {q:"The factory _____ we visited yesterday produces cars.", a:"that", opts:["that","where","which","in which"], cn:"我们昨天参观的那家工厂生产汽车。", tip:"that/which 作visited的宾语，不用where"},
  {q:"The factory _____ my father works is very large.", a:"where", opts:["where","that","which","in that"], cn:"我爸爸工作的那家工厂很大。", tip:"where = in which，从句中不缺宾语"},
  {q:"Is this the museum _____ you visited last week?", a:"that", opts:["that","where","which","in which"], cn:"这是你上周参观的博物馆吗？", tip:"that/which 作visited的宾语，不用where"},
  {q:"Is this the museum _____ the exhibition was held?", a:"where", opts:["where","that","which","in that"], cn:"这是举办展览的那个博物馆吗？", tip:"where = in which，从句中不缺宾语"},
  {q:"I have a friend _____ father is a famous scientist.", a:"whose", opts:["whose","who's","who","that"], cn:"我有一个朋友，他的父亲是著名科学家。", tip:"whose 表所属，≠ who's (= who is)"},
  {q:"This is the house _____ Lu Xun once lived.", a:"where", opts:["where","which","that","in that"], cn:"这是鲁迅曾经住过的房子。", tip:"where = in which，lived是不及物动词"},
  {q:"This is the house _____ Lu Xun once lived in.", a:"which", opts:["which","where","when","why"], cn:"这是鲁迅曾经住过的房子。", tip:"which/that 作in的宾语，介词后置"},
  {q:"October 1, 1949 was the day _____ the PRC was founded.", a:"when", opts:["when","which","that","on that"], cn:"1949年10月1日是中华人民共和国成立的日子。", tip:"when 修饰day，= on which"},
  {q:"Can you think of a situation _____ this word is used?", a:"where", opts:["where","which","that","in that"], cn:"你能想到这个词使用的场景吗？", tip:"where 修饰situation（抽象地点）"},
  {q:"We are living in an age _____ technology is developing rapidly.", a:"when", opts:["when","which","that","in that"], cn:"我们生活在一个技术飞速发展的时代。", tip:"when 修饰age（抽象时间）"},
  {q:"I'd like to live in a place _____ the air is clean.", a:"where", opts:["where","which","that","in that"], cn:"我想住在空气清新的地方。", tip:"where 修饰place"},
  {q:"I've reached a point _____ I can't go on.", a:"where", opts:["where","which","that","when"], cn:"我已经到了无法继续的地步。", tip:"where 修饰point（抽象地点）"},
  {q:"He is in a situation _____ he has to make a choice.", a:"where", opts:["where","which","that","when"], cn:"他处于必须做出选择的境况中。", tip:"where 修饰situation（抽象地点）"},
  {q:"She entered the room, the window of _____ was broken.", a:"which", opts:["which","that","whom","whose"], cn:"她走进了那个窗户破了的房间。", tip:"名词 + of which = whose + 名词"},
  {q:"There are 60 students in our class, _____ of whom are girls.", a:"30", opts:["30","that","which","whom"], cn:"我们班有60个学生，其中30个是女生。", tip:"数词/代词 + of whom/which 部分关系"},
  {q:"He has three sons, all of _____ are doctors.", a:"whom", opts:["whom","who","which","that"], cn:"他有三个儿子，都是医生。", tip:"all of whom 非限定性定语从句"},
  {q:"She bought two books, neither of _____ was interesting.", a:"which", opts:["which","whom","that","who"], cn:"她买了两本书，都不有趣。", tip:"neither of which 非限定性定语从句"},
  {q:"He has written ten novels, some of _____ have been translated.", a:"which", opts:["which","whom","that","who"], cn:"他写了十部小说，其中一些被翻译了。", tip:"some of which 非限定性定语从句"},
  {q:"There are 50 workers in the factory, most of _____ are women.", a:"whom", opts:["whom","who","which","that"], cn:"工厂有50个工人，大多数是女性。", tip:"most of whom 非限定性定语从句"},
  {q:"I bought a dozen eggs, half of _____ were broken.", a:"which", opts:["which","whom","that","who"], cn:"我买了一打鸡蛋，一半都碎了。", tip:"half of which 非限定性定语从句"},
  {q:"The manager, to _____ I wrote a letter, didn't reply.", a:"whom", opts:["whom","who","which","that"], cn:"我给经理写了一封信，他没有回复。", tip:"介词 + whom 非限定性定语从句"},
  {q:"as 引导定语从句：As _____ known to all, the earth is round.", a:"is", opts:["is","was","has","does"], cn:"众所周知，地球是圆的。", tip:"as is known to all 非限定性定语从句"},
  {q:"He is late, as _____ often the case.", a:"is", opts:["is","was","has","does"], cn:"他又迟到了，这是常有的事。", tip:"as is often the case 非限定性定语从句"},
  // ── 补充辨析题 (20题) ──────────────────────────────────────
  {q:"She is such a kind person _____ everyone likes.", a:"as", opts:["as","that","who","which"], cn:"她是一个人人都喜欢的善良的人。", tip:"such...as 定语从句，as作宾语"},
  {q:"This is the same dictionary _____ I bought yesterday.", a:"as", opts:["as","that","which","what"], cn:"这和我昨天买的是同样的词典。(同类)", tip:"the same...as 同类的（非同一个）"},
  {q:"He is such a good teacher _____ we all respect.", a:"as", opts:["as","that","who","which"], cn:"他是一个我们都尊敬的好老师。", tip:"such...as 定语从句，as作宾语"},
  {q:"The child _____ parents are both teachers is very smart.", a:"whose", opts:["whose","who","whom","which"], cn:"父母都是老师的那个孩子很聪明。", tip:"whose 表所属"},
  {q:"I live in the room _____ window faces south.", a:"whose", opts:["whose","which","that","of which"], cn:"我住在窗户朝南的那个房间。", tip:"whose 可修饰物，= the window of which"},
  {q:"He failed the exam, _____ was expected.", a:"as", opts:["as","which","that","what"], cn:"他考试不及格，这在意料之中。", tip:"as 引导非限定性定语从句，放句首或句中"},
  {q:"As _____ mentioned above, we need more time.", a:"was", opts:["was","is","has","had"], cn:"如上所述，我们需要更多时间。", tip:"as was mentioned above 非限定性定语从句"},
  {q:"The man _____ you shook hands with is our principal.", a:"whom", opts:["whom","who","which","whose"], cn:"和你握手的那个人是我们的校长。", tip:"whom 作with的宾语"},
  {q:"She has two sons, both of _____ are abroad.", a:"whom", opts:["whom","who","which","that"], cn:"她有两个儿子，都在国外。", tip:"both of whom 非限定性定语从句"},
  {q:"We walked into the room, in the middle of _____ stood a big table.", a:"which", opts:["which","that","whom","whose"], cn:"我们走进房间，中间放着一张大桌子。", tip:"介词短语 + which 非限定性定语从句"},
  {q:"There are many rivers in China, the longest of _____ is the Yangtze River.", a:"which", opts:["which","that","whom","whose"], cn:"中国有很多河流，最长的是长江。", tip:"the longest of which 非限定性定语从句"},
  {q:"He wore a mask, _____ made it hard to recognize him.", a:"which", opts:["which","that","who","whom"], cn:"他戴了面具，这使人很难认出他。", tip:"which 指代前面整个事件"},
  {q:"The girl _____ I think is the best student won the prize.", a:"who", opts:["who","whom","which","that"], cn:"我认为是最好的学生的那个女孩获了奖。", tip:"I think是插入语，who作主语"},
  {q:"He is a man _____ word you can always trust.", a:"whose", opts:["whose","who","whom","which"], cn:"他是一个你永远可以信任其话语的人。", tip:"whose word 表所属"},
  {q:"The teacher, _____ class I take, is very strict.", a:"whose", opts:["whose","who","whom","which"], cn:"我上他的课的那位老师非常严格。", tip:"whose 在非限定性定语从句中表所属"},
  {q:"She is the kind of girl _____ is always ready to help others.", a:"who", opts:["who","which","whom","whose"], cn:"她是那种总是乐于助人的女孩。", tip:"who 引导定语从句，修饰girl"},
  {q:"The time _____ I spent waiting was not wasted.", a:"that", opts:["that","when","which","in which"], cn:"我花在等待上的时间没有浪费。", tip:"that/which 作spent的宾语，time作时间名词但这里是宾语"},
  {q:"The way _____ he solved the problem was creative.", a:"that", opts:["that","which","in which","how"], cn:"他解决问题的方式很有创意。", tip:"the way that/in which/省略，不能用how"},
  {q:"The passengers, none of _____ were injured, were taken to a hotel.", a:"whom", opts:["whom","who","which","that"], cn:"乘客们都没有受伤，被送往一家酒店。", tip:"none of whom 非限定性定语从句"},
  {q:"He came from a family _____ members were all musicians.", a:"whose", opts:["whose","which","who","that"], cn:"他来自一个家庭成员都是音乐家的家庭。", tip:"whose 表所属"},
];

const PREPOSITION_QUESTIONS = [
  // ── at 的用法 (12题) ──────────────────────────────────────
  {q:"The meeting starts _____ 9 o'clock.", a:"at", opts:["at","in","on","by"], cn:"会议在9点开始。", tip:"at + 具体时刻"},
  {q:"She is good _____ playing the piano.", a:"at", opts:["at","in","on","with"], cn:"她擅长弹钢琴。", tip:"be good at 擅长"},
  {q:"He was surprised _____ the news.", a:"at", opts:["at","in","on","with"], cn:"他对这个消息感到惊讶。", tip:"be surprised at 对...感到惊讶"},
  {q:"We arrived _____ the airport just in time.", a:"at", opts:["at","in","on","to"], cn:"我们刚好及时到达机场。", tip:"arrive at + 小地点"},
  {q:"She stared _____ him in disbelief.", a:"at", opts:["at","to","on","in"], cn:"她难以置信地盯着他。", tip:"stare at 盯着看"},
  {q:"He laughed _____ my joke.", a:"at", opts:["at","to","on","with"], cn:"他听了我的笑话笑了。", tip:"laugh at 嘲笑/因...而笑"},
  {q:"The children are _____ school now.", a:"at", opts:["at","in","on","to"], cn:"孩子们现在在学校。", tip:"at school 在上学"},
  {q:"I'll meet you _____ the bus stop.", a:"at", opts:["at","in","on","to"], cn:"我在公交站等你。", tip:"at + 具体地点"},
  {q:"She was angry _____ herself for making the mistake.", a:"at", opts:["at","with","to","on"], cn:"她因犯了错误而生自己的气。", tip:"be angry at oneself 生自己的气"},
  {q:"He aimed the ball _____ the goal.", a:"at", opts:["at","to","in","on"], cn:"他把球瞄准球门。", tip:"aim at 瞄准"},
  {q:"_____ first, I didn't understand what he meant.", a:"At", opts:["At","In","On","By"], cn:"起初，我不明白他的意思。", tip:"at first 起初"},
  {q:"She looked _____ the painting for a long time.", a:"at", opts:["at","to","on","in"], cn:"她看了那幅画很长时间。", tip:"look at 看"},

  // ── in 的用法 (15题) ──────────────────────────────────────
  {q:"He was born _____ 1990.", a:"in", opts:["in","on","at","by"], cn:"他出生于1990年。", tip:"in + 年份"},
  {q:"We usually go on holiday _____ summer.", a:"in", opts:["in","on","at","by"], cn:"我们通常在夏天度假。", tip:"in + 季节"},
  {q:"She arrived _____ Beijing yesterday.", a:"in", opts:["in","at","on","to"], cn:"她昨天到达北京。", tip:"arrive in + 大城市/国家"},
  {q:"He is interested _____ music.", a:"in", opts:["in","at","on","with"], cn:"他对音乐感兴趣。", tip:"be interested in 对...感兴趣"},
  {q:"She is dressed _____ red today.", a:"in", opts:["in","on","with","by"], cn:"她今天穿着红色衣服。", tip:"dressed in + 颜色/衣服"},
  {q:"We should hand in the report _____ a week.", a:"in", opts:["in","after","on","at"], cn:"我们应该在一周内交报告。", tip:"in + 一段时间，表将来多久之后"},
  {q:"He succeeded _____ passing the exam.", a:"in", opts:["in","at","on","with"], cn:"他成功通过了考试。", tip:"succeed in doing 成功做某事"},
  {q:"She takes part _____ many school activities.", a:"in", opts:["in","at","on","with"], cn:"她参加很多学校活动。", tip:"take part in 参加"},
  {q:"The answer is written _____ pencil.", a:"in", opts:["in","with","by","on"], cn:"答案是用铅笔写的。", tip:"in + 笔墨材料，表书写工具"},
  {q:"He is always _____ a hurry.", a:"in", opts:["in","on","at","with"], cn:"他总是很匆忙。", tip:"in a hurry 匆忙"},
  {q:"_____ my opinion, this plan won't work.", a:"In", opts:["In","On","At","By"], cn:"在我看来，这个计划行不通。", tip:"in my opinion 在我看来"},
  {q:"She believes _____ herself.", a:"in", opts:["in","on","at","with"], cn:"她相信自己。", tip:"believe in 信任，信仰"},
  {q:"They live _____ the countryside.", a:"in", opts:["in","on","at","to"], cn:"他们住在乡下。", tip:"in the countryside 在乡下"},
  {q:"He is rich _____ experience.", a:"in", opts:["in","at","on","with"], cn:"他经验丰富。", tip:"be rich in 富于"},
  {q:"The movie is _____ English.", a:"in", opts:["in","on","at","with"], cn:"这部电影是英语的。", tip:"in + 语言"},

  // ── on 的用法 (12题) ──────────────────────────────────────
  {q:"The meeting is _____ Monday.", a:"on", opts:["on","in","at","by"], cn:"会议在星期一。", tip:"on + 星期几"},
  {q:"She was born _____ March 15th.", a:"on", opts:["on","in","at","by"], cn:"她出生于3月15日。", tip:"on + 具体日期"},
  {q:"The book is _____ the table.", a:"on", opts:["on","in","at","by"], cn:"书在桌子上。", tip:"on + 表面"},
  {q:"He depends _____ his parents for money.", a:"on", opts:["on","in","at","with"], cn:"他靠父母给钱。", tip:"depend on 依赖"},
  {q:"She congratulated me _____ my success.", a:"on", opts:["on","at","in","for"], cn:"她祝贺我的成功。", tip:"congratulate sb. on sth. 祝贺"},
  {q:"He spent a lot of money _____ books.", a:"on", opts:["on","in","at","for"], cn:"他在书上花了很多钱。", tip:"spend money on 在...上花钱"},
  {q:"_____ the whole, the party was a success.", a:"On", opts:["On","In","At","By"], cn:"总的来说，聚会很成功。", tip:"on the whole 总的来说"},
  {q:"She insists _____ going alone.", a:"on", opts:["on","in","at","with"], cn:"她坚持要一个人去。", tip:"insist on doing 坚持做"},
  {q:"He is keen _____ sports.", a:"on", opts:["on","in","at","with"], cn:"他热衷于体育运动。", tip:"be keen on 热衷于"},
  {q:"The picture is hanging _____ the wall.", a:"on", opts:["on","in","at","by"], cn:"画挂在墙上。", tip:"on the wall 在墙上（表面）"},
  {q:"She went to school _____ foot.", a:"on", opts:["on","by","in","with"], cn:"她步行去学校。", tip:"on foot 步行"},
  {q:"He has a big influence _____ his students.", a:"on", opts:["on","in","at","to"], cn:"他对学生有很大影响。", tip:"have an influence on 对...有影响"},

  // ── by 的用法 (10题) ──────────────────────────────────────
  {q:"The novel was written _____ Mark Twain.", a:"by", opts:["by","with","in","from"], cn:"这部小说是马克·吐温写的。", tip:"by + 动作执行者（被动语态）"},
  {q:"She goes to work _____ bus.", a:"by", opts:["by","on","in","with"], cn:"她乘公交车去上班。", tip:"by + 交通工具（无冠词）"},
  {q:"Please finish the work _____ Friday.", a:"by", opts:["by","until","in","on"], cn:"请在周五之前完成工作。", tip:"by + 时间点，表截止"},
  {q:"He grabbed me _____ the arm.", a:"by", opts:["by","on","in","at"], cn:"他抓住了我的胳膊。", tip:"grab/catch/hold sb. by the + 身体部位"},
  {q:"She learned English _____ listening to songs.", a:"by", opts:["by","with","in","through"], cn:"她通过听歌学英语。", tip:"by + doing 通过...方式"},
  {q:"The house was destroyed _____ the fire.", a:"by", opts:["by","with","in","from"], cn:"房子被火烧毁了。", tip:"by + 自然力量（被动语态）"},
  {q:"He stood _____ the window, looking outside.", a:"by", opts:["by","at","on","in"], cn:"他站在窗边，看着外面。", tip:"by 在...旁边"},
  {q:"She passed the exam _____ working hard.", a:"by", opts:["by","with","in","through"], cn:"她通过努力学习通过了考试。", tip:"by + doing 通过...方式"},
  {q:"I know him _____ sight but not _____ name.", a:"by...by", opts:["by...by","in...in","with...with","on...on"], cn:"我见过他但不知道他的名字。", tip:"by sight 见过面 / by name 知道名字"},
  {q:"_____ the way, have you seen my keys?", a:"By", opts:["By","In","On","At"], cn:"顺便问一下，你看到我的钥匙了吗？", tip:"by the way 顺便说一下"},

  // ── for 的用法 (10题) ──────────────────────────────────────
  {q:"I've been waiting _____ you for an hour.", a:"for", opts:["for","to","at","on"], cn:"我已经等你一个小时了。", tip:"wait for 等待"},
  {q:"She left _____ London this morning.", a:"for", opts:["for","to","at","in"], cn:"她今天早上动身去伦敦了。", tip:"leave for 动身前往"},
  {q:"Thank you _____ your help.", a:"for", opts:["for","to","at","on"], cn:"感谢你的帮助。", tip:"thank sb. for sth. 因...感谢"},
  {q:"This gift is _____ you.", a:"for", opts:["for","to","at","on"], cn:"这个礼物是给你的。", tip:"for + 对象，表给...的"},
  {q:"She apologized _____ being late.", a:"for", opts:["for","to","at","about"], cn:"她为迟到而道歉。", tip:"apologize for 为...道歉"},
  {q:"He has been living here _____ ten years.", a:"for", opts:["for","since","in","during"], cn:"他在这里住了十年了。", tip:"for + 一段时间"},
  {q:"We are looking _____ a new house.", a:"for", opts:["for","at","into","after"], cn:"我们在找新房子。", tip:"look for 寻找"},
  {q:"She is famous _____ her beautiful voice.", a:"for", opts:["for","as","to","with"], cn:"她以美丽的嗓音而闻名。", tip:"be famous for 因...而出名"},
  {q:"He was punished _____ cheating in the exam.", a:"for", opts:["for","by","with","to"], cn:"他因考试作弊而受到惩罚。", tip:"be punished for 因...被惩罚"},
  {q:"What did you have _____ breakfast?", a:"for", opts:["for","at","in","on"], cn:"你早餐吃了什么？", tip:"for breakfast/lunch/dinner 表某一餐"},

  // ── to 的用法 (10题) ──────────────────────────────────────
  {q:"She is kind _____ everyone.", a:"to", opts:["to","for","with","at"], cn:"她对每个人都很友善。", tip:"be kind to 对...友善"},
  {q:"This road leads _____ the village.", a:"to", opts:["to","for","at","in"], cn:"这条路通往村庄。", tip:"lead to 通向"},
  {q:"He paid attention _____ the teacher's words.", a:"to", opts:["to","for","at","on"], cn:"他注意听老师的话。", tip:"pay attention to 注意"},
  {q:"The answer _____ the question is easy.", a:"to", opts:["to","of","for","on"], cn:"这个问题的答案很简单。", tip:"the answer to 答案"},
  {q:"She is used _____ getting up early.", a:"to", opts:["to","for","at","in"], cn:"她习惯早起。", tip:"be used to doing 习惯于"},
  {q:"He is similar _____ his father.", a:"to", opts:["to","with","as","like"], cn:"他和他父亲很像。", tip:"be similar to 和...相似"},
  {q:"They object _____ the new plan.", a:"to", opts:["to","for","at","on"], cn:"他们反对这个新计划。", tip:"object to 反对"},
  {q:"Please turn _____ the right at the corner.", a:"to", opts:["to","on","at","in"], cn:"请在拐角处向右转。", tip:"turn to the right 向右转"},
  {q:"Compared _____ last year, sales have increased.", a:"to", opts:["to","with","for","by"], cn:"与去年相比，销售额增加了。", tip:"compared to/with 与...相比"},
  {q:"He devoted his life _____ science.", a:"to", opts:["to","for","in","on"], cn:"他把一生献给了科学。", tip:"devote...to 把...献给"},

  // ── with 的用法 (10题) ──────────────────────────────────────
  {q:"She cut the cake _____ a knife.", a:"with", opts:["with","by","in","on"], cn:"她用刀切了蛋糕。", tip:"with + 具体工具"},
  {q:"He is satisfied _____ his job.", a:"with", opts:["with","at","in","on"], cn:"他对工作很满意。", tip:"be satisfied with 对...满意"},
  {q:"I agree _____ you on this point.", a:"with", opts:["with","to","on","in"], cn:"在这一点上我同意你。", tip:"agree with sb. 同意某人"},
  {q:"She is popular _____ her classmates.", a:"with", opts:["with","to","for","in"], cn:"她在同学中很受欢迎。", tip:"be popular with 受...欢迎"},
  {q:"He was shaking _____ cold.", a:"with", opts:["with","by","from","of"], cn:"他冷得发抖。", tip:"shake with 因...而颤抖"},
  {q:"She covered the table _____ a cloth.", a:"with", opts:["with","by","in","on"], cn:"她用布盖住了桌子。", tip:"cover...with 用...覆盖"},
  {q:"Don't argue _____ your parents.", a:"with", opts:["with","to","at","on"], cn:"不要和父母争吵。", tip:"argue with sb. 和某人争论"},
  {q:"He provided us _____ food and water.", a:"with", opts:["with","for","to","by"], cn:"他给我们提供了食物和水。", tip:"provide sb. with sth. 向某人提供"},
  {q:"She was busy _____ her homework.", a:"with", opts:["with","in","at","on"], cn:"她忙于做作业。", tip:"be busy with sth. 忙于"},
  {q:"The garden was filled _____ beautiful flowers.", a:"with", opts:["with","by","of","in"], cn:"花园里开满了美丽的花。", tip:"be filled with 充满"},

  // ── of 的用法 (10题) ──────────────────────────────────────
  {q:"She is afraid _____ dogs.", a:"of", opts:["of","at","with","from"], cn:"她怕狗。", tip:"be afraid of 害怕"},
  {q:"The desk is made _____ wood.", a:"of", opts:["of","from","by","with"], cn:"这张桌子是木头做的。", tip:"be made of 由...制成（看得出原材料）"},
  {q:"Wine is made _____ grapes.", a:"from", opts:["from","of","by","with"], cn:"葡萄酒是用葡萄酿的。", tip:"be made from 由...制成（看不出原材料）"},
  {q:"He is proud _____ his daughter.", a:"of", opts:["of","for","with","at"], cn:"他为女儿感到骄傲。", tip:"be proud of 为...骄傲"},
  {q:"She is tired _____ doing the same thing every day.", a:"of", opts:["of","with","from","at"], cn:"她厌倦了每天做同样的事。", tip:"be tired of 厌倦"},
  {q:"He reminded me _____ my father.", a:"of", opts:["of","about","with","to"], cn:"他让我想起了我的父亲。", tip:"remind sb. of 使某人想起"},
  {q:"The city is north _____ Shanghai.", a:"of", opts:["of","to","from","in"], cn:"这座城市在上海以北。", tip:"方位 + of 在...方向（接壤外部）"},
  {q:"She is aware _____ the danger.", a:"of", opts:["of","about","with","to"], cn:"她意识到了危险。", tip:"be aware of 意识到"},
  {q:"He accused her _____ stealing.", a:"of", opts:["of","for","with","about"], cn:"他指控她偷窃。", tip:"accuse sb. of 指控某人"},
  {q:"I am fond _____ reading novels.", a:"of", opts:["of","in","at","with"], cn:"我喜欢读小说。", tip:"be fond of 喜欢"},

  // ── from 的用法 (8题) ──────────────────────────────────────
  {q:"He comes _____ a small town.", a:"from", opts:["from","of","in","at"], cn:"他来自一个小镇。", tip:"come from 来自"},
  {q:"She prevented him _____ making a mistake.", a:"from", opts:["from","of","to","with"], cn:"她阻止了他犯错。", tip:"prevent sb. from doing 阻止某人做某事"},
  {q:"The shop is open _____ 9 am to 5 pm.", a:"from", opts:["from","since","at","in"], cn:"这家店从早上9点营业到下午5点。", tip:"from...to 从...到"},
  {q:"He is different _____ his brother.", a:"from", opts:["from","with","to","than"], cn:"他和他哥哥不同。", tip:"be different from 与...不同"},
  {q:"She suffered _____ a serious illness.", a:"from", opts:["from","of","with","by"], cn:"她患了重病。", tip:"suffer from 遭受，患...病"},
  {q:"He was absent _____ school yesterday.", a:"from", opts:["from","at","in","of"], cn:"他昨天没来上学。", tip:"be absent from 缺席"},
  {q:"She graduated _____ a famous university.", a:"from", opts:["from","at","in","of"], cn:"她毕业于一所名牌大学。", tip:"graduate from 从...毕业"},
  {q:"This painting dates _____ the 18th century.", a:"from", opts:["from","to","in","of"], cn:"这幅画可以追溯到18世纪。", tip:"date from 始于，追溯到"},

  // ── about 的用法 (8题) ──────────────────────────────────────
  {q:"I'm worried _____ the exam.", a:"about", opts:["about","of","for","with"], cn:"我为考试担心。", tip:"be worried about 担心"},
  {q:"Tell me something _____ yourself.", a:"about", opts:["about","of","for","with"], cn:"告诉我一些关于你自己的事。", tip:"about 关于"},
  {q:"She complained _____ the noise.", a:"about", opts:["about","of","for","with"], cn:"她抱怨噪音。", tip:"complain about 抱怨"},
  {q:"He is curious _____ everything.", a:"about", opts:["about","of","for","at"], cn:"他对一切都很好奇。", tip:"be curious about 对...好奇"},
  {q:"What _____ going for a walk?", a:"about", opts:["about","of","for","with"], cn:"去散步怎么样？", tip:"what about + doing 表建议"},
  {q:"She cares _____ the environment.", a:"about", opts:["about","of","for","with"], cn:"她关心环境。", tip:"care about 关心"},
  {q:"He thought _____ the problem for a long time.", a:"about", opts:["about","of","for","with"], cn:"他思考了这个问题很长时间。", tip:"think about 思考"},
  {q:"Don't worry _____ me. I'll be fine.", a:"about", opts:["about","of","for","with"], cn:"别担心我，我会没事的。", tip:"worry about 担心"},

  // ── through / across / over / along (12题) ──────────────────────────────────────
  {q:"The river flows _____ the city.", a:"through", opts:["through","across","over","along"], cn:"河流穿过城市。", tip:"through 穿过（从内部穿过）"},
  {q:"She walked _____ the street to the shop.", a:"across", opts:["across","through","over","along"], cn:"她穿过马路到商店去。", tip:"across 横穿（从表面穿过）"},
  {q:"The plane flew _____ the mountains.", a:"over", opts:["over","through","across","along"], cn:"飞机飞越了群山。", tip:"over 越过，从上方经过"},
  {q:"We walked _____ the river bank.", a:"along", opts:["along","across","through","over"], cn:"我们沿着河岸走。", tip:"along 沿着"},
  {q:"He got the job _____ hard work.", a:"through", opts:["through","across","over","by"], cn:"他通过努力工作得到了这份工作。", tip:"through 通过（方式/途径）"},
  {q:"The dog jumped _____ the fence.", a:"over", opts:["over","through","across","along"], cn:"狗跳过了篱笆。", tip:"over 跳过，越过"},
  {q:"She drove _____ the tunnel carefully.", a:"through", opts:["through","across","over","along"], cn:"她小心地开车穿过隧道。", tip:"through 穿过（从内部）"},
  {q:"We swam _____ the lake.", a:"across", opts:["across","through","over","along"], cn:"我们游过了湖。", tip:"across 横穿（从一边到另一边）"},
  {q:"He looked _____ the window at the garden.", a:"through", opts:["through","across","over","along"], cn:"他透过窗户看花园。", tip:"through 透过"},
  {q:"She ran _____ the bridge.", a:"across", opts:["across","through","over","along"], cn:"她跑过了桥。", tip:"across/over 从桥一端到另一端"},
  {q:"We drove _____ the coast all day.", a:"along", opts:["along","across","through","over"], cn:"我们沿着海岸开了一整天。", tip:"along 沿着"},
  {q:"He read the document _____ quickly.", a:"through", opts:["through","across","over","along"], cn:"他快速浏览了文件。", tip:"read through 通读，浏览"},

  // ── between / among (6题) ──────────────────────────────────────
  {q:"She sat _____ Tom and Jerry.", a:"between", opts:["between","among","in","with"], cn:"她坐在汤姆和杰瑞之间。", tip:"between 在两者之间"},
  {q:"He is popular _____ his classmates.", a:"among", opts:["among","between","in","with"], cn:"他在同学中很受欢迎。", tip:"among 在三者或以上之中"},
  {q:"The secret is _____ you and me.", a:"between", opts:["between","among","in","with"], cn:"这是你我之间的秘密。", tip:"between you and me 你我之间"},
  {q:"She distributed the sweets _____ the children.", a:"among", opts:["among","between","in","to"], cn:"她把糖果分给了孩子们。", tip:"among 在三者或以上之中分配"},
  {q:"What's the difference _____ these two words?", a:"between", opts:["between","among","in","of"], cn:"这两个词之间有什么区别？", tip:"between 两者之间的区别"},
  {q:"He found a rare flower _____ the weeds.", a:"among", opts:["among","between","in","with"], cn:"他在杂草中发现了一朵稀有的花。", tip:"among 在（三者以上）之中"},

  // ── above / below / over / under / beneath (10题) ──────────────────────────────────────
  {q:"The temperature is 10 degrees _____ zero.", a:"below", opts:["below","under","beneath","above"], cn:"温度在零下10度。", tip:"below zero 零下"},
  {q:"The plane flew _____ the clouds.", a:"above", opts:["above","over","on","up"], cn:"飞机在云层上方飞行。", tip:"above 在...上方（不接触）"},
  {q:"There is a bridge _____ the river.", a:"over", opts:["over","above","on","up"], cn:"河上有一座桥。", tip:"over 在...正上方（跨越）"},
  {q:"The cat is hiding _____ the bed.", a:"under", opts:["under","below","beneath","above"], cn:"猫藏在床底下。", tip:"under 在...下面（正下方）"},
  {q:"Children _____ 12 must be accompanied by an adult.", a:"under", opts:["under","below","beneath","above"], cn:"12岁以下的儿童必须有成人陪同。", tip:"under + 年龄，表低于"},
  {q:"The temperature today is _____ average.", a:"above", opts:["above","over","on","up"], cn:"今天的温度高于平均水平。", tip:"above average 高于平均"},
  {q:"She felt the ground move _____ her feet.", a:"beneath", opts:["beneath","under","below","above"], cn:"她感到脚下的地面在动。", tip:"beneath 在...下方（紧贴下方）"},
  {q:"Keep the medicine _____ the reach of children.", a:"beyond", opts:["beyond","above","over","out of"], cn:"把药放在儿童够不到的地方。", tip:"beyond the reach of 超出...的触及范围"},
  {q:"The project is _____ our budget.", a:"within", opts:["within","under","below","in"], cn:"这个项目在我们的预算之内。", tip:"within + 范围，在...之内"},
  {q:"He is _____ pressure to finish the project.", a:"under", opts:["under","in","on","at"], cn:"他面临着完成项目的压力。", tip:"under pressure 在压力下"},

  // ── during / since / until / till (8题) ──────────────────────────────────────
  {q:"She fell asleep _____ the lecture.", a:"during", opts:["during","while","for","in"], cn:"她在讲座期间睡着了。", tip:"during + 名词，在...期间"},
  {q:"He has lived here _____ 2010.", a:"since", opts:["since","for","from","during"], cn:"他从2010年起就住在这里了。", tip:"since + 时间点，自从"},
  {q:"Wait here _____ I come back.", a:"until", opts:["until","since","during","while"], cn:"在这里等到我回来。", tip:"until 直到...为止"},
  {q:"She didn't go to bed _____ midnight.", a:"until", opts:["until","since","during","from"], cn:"她直到半夜才睡觉。", tip:"not...until 直到...才"},
  {q:"Many things happened _____ the summer vacation.", a:"during", opts:["during","while","for","in"], cn:"暑假期间发生了很多事。", tip:"during + 名词，在...期间"},
  {q:"I have known him _____ we were children.", a:"since", opts:["since","for","from","during"], cn:"从我们小时候起我就认识他了。", tip:"since + 过去时间，自从"},
  {q:"The shop is open _____ 10 pm.", a:"until", opts:["until","since","during","from"], cn:"这家店营业到晚上10点。", tip:"until 直到"},
  {q:"_____ his stay in Paris, he visited many museums.", a:"During", opts:["During","While","For","In"], cn:"他在巴黎逗留期间参观了很多博物馆。", tip:"during + 名词，在...期间"},

  // ── into / out of / off / onto (8题) ──────────────────────────────────────
  {q:"She ran _____ the room crying.", a:"into", opts:["into","in","to","onto"], cn:"她哭着跑进了房间。", tip:"into 进入（有动作方向）"},
  {q:"The cat jumped _____ the table.", a:"off", opts:["off","of","from","out"], cn:"猫从桌子上跳了下来。", tip:"off 离开表面"},
  {q:"He climbed _____ the roof.", a:"onto", opts:["onto","on","into","up"], cn:"他爬到了屋顶上。", tip:"onto 到...上面（有动作）"},
  {q:"She got _____ the car and walked away.", a:"out of", opts:["out of","off","from","away"], cn:"她下了车走开了。", tip:"get out of 从...出来"},
  {q:"He translated the novel _____ Chinese.", a:"into", opts:["into","to","in","for"], cn:"他把小说翻译成中文。", tip:"translate into 翻译成"},
  {q:"Take your feet _____ the desk!", a:"off", opts:["off","of","from","out"], cn:"把脚从桌子上拿下来！", tip:"off 离开（表面）"},
  {q:"She turned her hobby _____ a business.", a:"into", opts:["into","to","for","as"], cn:"她把爱好变成了事业。", tip:"turn into 变成"},
  {q:"He fell _____ the swimming pool.", a:"into", opts:["into","in","to","on"], cn:"他掉进了游泳池。", tip:"fall into 掉入"},

  // ── beside / besides / except / except for (8题) ──────────────────────────────────────
  {q:"She sat _____ me during the meeting.", a:"beside", opts:["beside","besides","except","next"], cn:"会议期间她坐在我旁边。", tip:"beside 在...旁边"},
  {q:"_____ English, she also speaks French.", a:"Besides", opts:["Besides","Beside","Except","But"], cn:"除了英语，她还会说法语。", tip:"besides 除了...之外（还有）"},
  {q:"Everyone passed _____ Tom.", a:"except", opts:["except","besides","beside","but for"], cn:"除了汤姆，所有人都通过了。", tip:"except 除了...之外（不包括）"},
  {q:"The essay is good _____ a few spelling errors.", a:"except for", opts:["except for","besides","beside","except"], cn:"这篇文章除了几个拼写错误外很好。", tip:"except for 除了...（不同类事物的瑕疵）"},
  {q:"There is nothing _____ a table in the room.", a:"besides", opts:["besides","beside","except","but"], cn:"房间里除了一张桌子什么也没有。", tip:"besides = apart from 除...之外（还有/没有）"},
  {q:"All the students went _____ John.", a:"except", opts:["except","besides","beside","apart"], cn:"除了约翰，所有学生都去了。", tip:"except 除了...之外（排除）"},
  {q:"She stood _____ the lake and enjoyed the view.", a:"beside", opts:["beside","besides","except","near"], cn:"她站在湖边欣赏风景。", tip:"beside 在...旁边"},
  {q:"_____ being a teacher, he is also a writer.", a:"Besides", opts:["Besides","Beside","Except","But"], cn:"除了当老师，他还是一位作家。", tip:"besides + doing 除了...之外还"},

  // ── against / toward / beyond / within / without / despite (18题) ──────────────────
  {q:"He leaned _____ the wall.", a:"against", opts:["against","on","to","at"], cn:"他靠着墙。", tip:"lean against 靠着"},
  {q:"Are you for or _____ the plan?", a:"against", opts:["against","to","with","on"], cn:"你赞成还是反对这个计划？", tip:"against 反对"},
  {q:"She walked _____ the door slowly.", a:"toward", opts:["toward","against","to","at"], cn:"她慢慢走向门口。", tip:"toward(s) 朝...方向"},
  {q:"The task is _____ my ability.", a:"beyond", opts:["beyond","above","over","out"], cn:"这项任务超出了我的能力。", tip:"beyond 超出...范围"},
  {q:"I'll finish the report _____ two days.", a:"within", opts:["within","in","during","for"], cn:"我会在两天之内完成报告。", tip:"within + 时间，在...之内"},
  {q:"She left _____ saying goodbye.", a:"without", opts:["without","with","by","besides"], cn:"她没说再见就走了。", tip:"without + doing 没有...就"},
  {q:"_____ the rain, they went on the picnic.", a:"Despite", opts:["Despite","Although","Because","Since"], cn:"尽管下雨，他们还是去野餐了。", tip:"despite + 名词短语，尽管"},
  {q:"She succeeded _____ great difficulties.", a:"despite", opts:["despite","although","because","with"], cn:"尽管困难重重她还是成功了。", tip:"despite + 名词短语，尽管"},
  {q:"The ball bounced _____ the wall.", a:"against", opts:["against","to","on","at"], cn:"球弹到了墙上。", tip:"against 碰撞（接触表面）"},
  {q:"His attitude _____ life is very positive.", a:"toward", opts:["toward","to","for","about"], cn:"他对生活的态度非常积极。", tip:"attitude toward(s) 对...的态度"},
  {q:"The village is _____ the mountains.", a:"beyond", opts:["beyond","behind","above","over"], cn:"村庄在山的那边。", tip:"beyond 在...的那一边"},
  {q:"She can't live _____ music.", a:"without", opts:["without","with","by","besides"], cn:"她离不开音乐。", tip:"without 没有"},
  {q:"_____ all his wealth, he is unhappy.", a:"Despite", opts:["Despite","Although","Because","With"], cn:"尽管他很富有，他并不开心。", tip:"despite + 名词短语，尽管"},
  {q:"He competed _____ many strong opponents.", a:"against", opts:["against","with","to","for"], cn:"他与许多强劲对手竞争。", tip:"compete against 与...竞争"},
  {q:"We must finish this _____ the hour.", a:"within", opts:["within","in","during","by"], cn:"我们必须在一小时之内完成。", tip:"within + 时间，在...之内"},
  {q:"They fought _____ the enemy bravely.", a:"against", opts:["against","with","to","for"], cn:"他们勇敢地与敌人作战。", tip:"fight against 与...战斗"},
  {q:"She walked away _____ looking back.", a:"without", opts:["without","with","by","besides"], cn:"她头也不回地走开了。", tip:"without + doing 没有...就"},
  {q:"_____ his young age, he showed great maturity.", a:"Despite", opts:["Despite","Although","Because","With"], cn:"尽管他年纪小，却表现出很大的成熟。", tip:"despite + 名词短语，尽管"},

  // ── 介词固定搭配与短语动词 (33题) ──────────────────────────────────────
  {q:"He is responsible _____ the project.", a:"for", opts:["for","to","of","with"], cn:"他负责这个项目。", tip:"be responsible for 对...负责"},
  {q:"She is concerned _____ her children's education.", a:"about", opts:["about","of","for","with"], cn:"她关心孩子们的教育。", tip:"be concerned about 关心，担心"},
  {q:"The teacher is strict _____ the students.", a:"with", opts:["with","to","on","at"], cn:"老师对学生很严格。", tip:"be strict with sb. 对某人严格"},
  {q:"He is allergic _____ peanuts.", a:"to", opts:["to","of","with","for"], cn:"他对花生过敏。", tip:"be allergic to 对...过敏"},
  {q:"She is patient _____ her students.", a:"with", opts:["with","to","for","at"], cn:"她对学生很有耐心。", tip:"be patient with 对...有耐心"},
  {q:"He is addicted _____ video games.", a:"to", opts:["to","of","with","in"], cn:"他沉迷于电子游戏。", tip:"be addicted to 沉迷于"},
  {q:"This medicine is harmful _____ your health.", a:"to", opts:["to","for","of","with"], cn:"这种药对你的健康有害。", tip:"be harmful to 对...有害"},
  {q:"I'm grateful _____ you for your help.", a:"to", opts:["to","for","of","with"], cn:"我感谢你的帮助。", tip:"be grateful to sb. 对某人感激"},
  {q:"He applied _____ the job last week.", a:"for", opts:["for","to","at","on"], cn:"他上周申请了这份工作。", tip:"apply for 申请"},
  {q:"She focused _____ her studies.", a:"on", opts:["on","in","at","to"], cn:"她专注于学业。", tip:"focus on 专注于"},
  {q:"He relies _____ his friends for support.", a:"on", opts:["on","in","at","to"], cn:"他依靠朋友的支持。", tip:"rely on 依赖"},
  {q:"She adapted _____ the new environment quickly.", a:"to", opts:["to","in","at","with"], cn:"她很快适应了新环境。", tip:"adapt to 适应"},
  {q:"He contributed _____ the charity.", a:"to", opts:["to","for","in","at"], cn:"他为慈善事业做了贡献。", tip:"contribute to 贡献给"},
  {q:"She is engaged _____ her work.", a:"in", opts:["in","on","at","to"], cn:"她忙于工作。", tip:"be engaged in 忙于"},
  {q:"He is superior _____ his classmates in math.", a:"to", opts:["to","than","over","from"], cn:"他的数学比同学们好。", tip:"be superior to 优于（不用than）"},
  {q:"She is inferior _____ nobody.", a:"to", opts:["to","than","from","with"], cn:"她不比任何人差。", tip:"be inferior to 劣于（不用than）"},
  {q:"The teacher is very patient _____ beginners.", a:"with", opts:["with","to","for","at"], cn:"这位老师对初学者很有耐心。", tip:"be patient with 对...有耐心"},
  {q:"He was charged _____ theft.", a:"with", opts:["with","for","of","about"], cn:"他被指控盗窃。", tip:"be charged with 被指控"},
  {q:"She is devoted _____ her family.", a:"to", opts:["to","for","in","with"], cn:"她全心奉献给家庭。", tip:"be devoted to 献身于"},
  {q:"He belongs _____ a sports club.", a:"to", opts:["to","in","at","with"], cn:"他属于一个体育俱乐部。", tip:"belong to 属于"},
  {q:"She complained _____ the manager about the service.", a:"to", opts:["to","at","for","with"], cn:"她向经理投诉了服务质量。", tip:"complain to sb. about sth. 向某人抱怨"},
  {q:"He insisted _____ paying for dinner.", a:"on", opts:["on","in","at","for"], cn:"他坚持要请客。", tip:"insist on doing 坚持做"},
  {q:"She is familiar _____ this area.", a:"with", opts:["with","to","in","at"], cn:"她对这个地区很熟悉。", tip:"be familiar with 对...熟悉"},
  {q:"This book is similar _____ that one.", a:"to", opts:["to","with","as","like"], cn:"这本书和那本很相似。", tip:"be similar to 与...相似"},
  {q:"He is content _____ his life.", a:"with", opts:["with","to","for","in"], cn:"他对自己的生活很满足。", tip:"be content with 对...满足"},
  {q:"She is accustomed _____ getting up early.", a:"to", opts:["to","with","for","in"], cn:"她习惯早起。", tip:"be accustomed to doing 习惯于"},
  {q:"We are short _____ time.", a:"of", opts:["of","in","on","for"], cn:"我们时间不够。", tip:"be short of 缺少"},
  {q:"She is capable _____ handling the task.", a:"of", opts:["of","in","for","to"], cn:"她有能力处理这项任务。", tip:"be capable of 有能力做"},
  {q:"He is eager _____ learn new things.", a:"to", opts:["to","for","of","in"], cn:"他渴望学习新事物。", tip:"be eager to do 渴望做"},
  {q:"She is independent _____ her parents.", a:"of", opts:["of","from","to","with"], cn:"她独立于父母。", tip:"be independent of 独立于"},
  {q:"He is guilty _____ the crime.", a:"of", opts:["of","for","with","in"], cn:"他犯了这个罪。", tip:"be guilty of 犯有...罪"},
  {q:"She looked _____ the children while their mother was away.", a:"after", opts:["after","for","at","into"], cn:"妈妈不在时她照顾孩子们。", tip:"look after 照顾"},
  {q:"The police are looking _____ the case.", a:"into", opts:["into","for","at","after"], cn:"警方正在调查这个案件。", tip:"look into 调查"},
];

const TENSE_QUESTIONS = [
  // ── 一般现在时 (15题) ──────────────────────────────────────
  {q:"She _____ (go) to school by bus every day.", a:"goes", opts:["goes","go","went","is going"], cn:"她每天乘公交车上学。", tip:"每天 → 一般现在时，三单加-es"},
  {q:"Water _____ (boil) at 100 degrees Celsius.", a:"boils", opts:["boils","boiled","is boiling","has boiled"], cn:"水在100摄氏度时沸腾。", tip:"科学事实 → 一般现在时"},
  {q:"The Earth _____ (move) around the Sun.", a:"moves", opts:["moves","moved","is moving","has moved"], cn:"地球绕着太阳转。", tip:"客观真理 → 一般现在时"},
  {q:"He _____ (not/like) coffee.", a:"doesn't like", opts:["doesn't like","don't like","didn't like","isn't liking"], cn:"他不喜欢咖啡。", tip:"习惯性否定 → doesn't + 动词原形"},
  {q:"_____ she _____ (speak) French?", a:"Does...speak", opts:["Does...speak","Do...speak","Is...speaking","Has...spoken"], cn:"她会说法语吗？", tip:"三单疑问 → Does + 主语 + 动词原形"},
  {q:"The train _____ (leave) at 8:30 every morning.", a:"leaves", opts:["leaves","left","is leaving","has left"], cn:"火车每天早上8:30出发。", tip:"时刻表/固定安排 → 一般现在时"},
  {q:"If it _____ (rain) tomorrow, we'll stay home.", a:"rains", opts:["rains","will rain","rained","is raining"], cn:"如果明天下雨，我们就待在家里。", tip:"条件状语从句中用一般现在时代替将来时"},
  {q:"I'll call you as soon as he _____ (arrive).", a:"arrives", opts:["arrives","will arrive","arrived","is arriving"], cn:"他一到我就给你打电话。", tip:"时间状语从句中用一般现在时代替将来时"},
  {q:"Tom usually _____ (get) up at 6 o'clock.", a:"gets", opts:["gets","get","got","is getting"], cn:"汤姆通常六点起床。", tip:"usually → 一般现在时"},
  {q:"She never _____ (eat) meat.", a:"eats", opts:["eats","eat","ate","is eating"], cn:"她从不吃肉。", tip:"never → 频率副词，一般现在时"},
  {q:"The shop _____ (open) at 9 am and _____ (close) at 6 pm.", a:"opens...closes", opts:["opens...closes","opened...closed","is opening...closing","has opened...closed"], cn:"商店早9开门晚6关门。", tip:"每天规律 → 一般现在时"},
  {q:"He _____ (work) as a doctor in this hospital.", a:"works", opts:["works","work","worked","is working"], cn:"他在这家医院当医生。", tip:"职业状态 → 一般现在时"},
  {q:"My father _____ (read) the newspaper every morning.", a:"reads", opts:["reads","read","is reading","has read"], cn:"我爸爸每天早上看报纸。", tip:"every morning → 一般现在时"},
  {q:"The sun _____ (rise) in the east.", a:"rises", opts:["rises","rose","is rising","has risen"], cn:"太阳从东方升起。", tip:"自然规律 → 一般现在时"},
  {q:"She _____ (teach) English at a middle school.", a:"teaches", opts:["teaches","teach","taught","is teaching"], cn:"她在一所中学教英语。", tip:"职业描述 → 一般现在时"},

  // ── 一般过去时 (15题) ──────────────────────────────────────
  {q:"She _____ (visit) her grandmother last weekend.", a:"visited", opts:["visited","visits","has visited","is visiting"], cn:"她上周末去看望了奶奶。", tip:"last weekend → 一般过去时"},
  {q:"He _____ (buy) a new car yesterday.", a:"bought", opts:["bought","buys","has bought","is buying"], cn:"他昨天买了一辆新车。", tip:"yesterday → 一般过去时"},
  {q:"They _____ (not/go) to the party last night.", a:"didn't go", opts:["didn't go","don't go","haven't gone","aren't going"], cn:"他们昨晚没去参加派对。", tip:"last night → 一般过去时否定"},
  {q:"_____ you _____ (see) the movie last Friday?", a:"Did...see", opts:["Did...see","Do...see","Have...seen","Are...seeing"], cn:"你上周五看了那部电影吗？", tip:"last Friday → 一般过去时疑问"},
  {q:"The accident _____ (happen) at 3 pm yesterday.", a:"happened", opts:["happened","happens","has happened","is happening"], cn:"事故发生在昨天下午3点。", tip:"yesterday → 一般过去时"},
  {q:"She _____ (be) very tired after the long walk.", a:"was", opts:["was","is","has been","will be"], cn:"长途步行后她很累。", tip:"叙述过去状态 → 一般过去时"},
  {q:"He _____ (write) three letters this morning. (It's now afternoon.)", a:"wrote", opts:["wrote","writes","has written","is writing"], cn:"他今天上午写了三封信。（现在已是下午）", tip:"this morning已过去 → 一般过去时"},
  {q:"When _____ you _____ (arrive) in Beijing?", a:"did...arrive", opts:["did...arrive","do...arrive","have...arrived","are...arriving"], cn:"你什么时候到达北京的？", tip:"询问过去具体时间 → 一般过去时"},
  {q:"Columbus _____ (discover) America in 1492.", a:"discovered", opts:["discovered","discovers","has discovered","had discovered"], cn:"哥伦布在1492年发现了美洲。", tip:"历史事件 → 一般过去时"},
  {q:"She _____ (meet) her husband at a party in 2010.", a:"met", opts:["met","meets","has met","is meeting"], cn:"她2010年在一个聚会上认识了她丈夫。", tip:"in 2010 → 一般过去时"},
  {q:"I _____ (lose) my wallet on the way to school.", a:"lost", opts:["lost","lose","have lost","am losing"], cn:"我在上学路上丢了钱包。", tip:"叙述过去事件 → 一般过去时"},
  {q:"They _____ (live) in London for five years before moving here.", a:"lived", opts:["lived","live","have lived","had lived"], cn:"搬来之前他们在伦敦住了五年。", tip:"before moving → 过去已结束的状态"},
  {q:"The phone _____ (ring) while I was in the shower.", a:"rang", opts:["rang","rings","has rung","was ringing"], cn:"我洗澡时电话响了。", tip:"过去某刻的短暂动作 → 一般过去时"},
  {q:"She _____ (not/know) the answer to the question.", a:"didn't know", opts:["didn't know","doesn't know","hasn't known","isn't knowing"], cn:"她不知道那个问题的答案。", tip:"叙述过去 → 一般过去时"},
  {q:"He _____ (break) his leg in a football match.", a:"broke", opts:["broke","breaks","has broken","is breaking"], cn:"他在一场足球赛中摔断了腿。", tip:"叙述过去事件 → 一般过去时"},

  // ── 一般将来时 (12题) ──────────────────────────────────────
  {q:"It _____ (rain) this afternoon according to the forecast.", a:"will rain", opts:["will rain","rains","rained","is raining"], cn:"根据预报今天下午会下雨。", tip:"天气预报 → will + 动词原形"},
  {q:"She _____ (be) 18 years old next month.", a:"will be", opts:["will be","is","was","has been"], cn:"她下个月就18岁了。", tip:"next month → 一般将来时"},
  {q:"I _____ (not/tell) anyone your secret.", a:"won't tell", opts:["won't tell","don't tell","didn't tell","haven't told"], cn:"我不会告诉任何人你的秘密。", tip:"承诺 → will not + 动词原形"},
  {q:"We _____ (have) a meeting tomorrow morning.", a:"will have", opts:["will have","have","had","are having"], cn:"我们明天上午要开会。", tip:"tomorrow → 一般将来时"},
  {q:"He _____ (graduate) from university next year.", a:"will graduate", opts:["will graduate","graduates","graduated","is graduating"], cn:"他明年大学毕业。", tip:"next year → 一般将来时"},
  {q:"I think she _____ (win) the competition.", a:"will win", opts:["will win","wins","won","is winning"], cn:"我认为她会赢得比赛。", tip:"I think → 预测用will"},
  {q:"_____ you _____ (come) to my birthday party?", a:"Will...come", opts:["Will...come","Do...come","Did...come","Are...coming"], cn:"你会来参加我的生日派对吗？", tip:"邀请/询问 → will"},
  {q:"The new bridge _____ (be) completed next year.", a:"will be", opts:["will be","is","was","has been"], cn:"新桥明年竣工。", tip:"next year → 一般将来时"},
  {q:"Don't worry. Everything _____ (be) fine.", a:"will be", opts:["will be","is","was","has been"], cn:"别担心，一切都会好的。", tip:"安慰/预测 → will"},
  {q:"She _____ (not/attend) the meeting because she is sick.", a:"won't attend", opts:["won't attend","doesn't attend","didn't attend","hasn't attended"], cn:"她不会参加会议因为她生病了。", tip:"将来否定 → won't + 动词原形"},
  {q:"I _____ (be going to) visit my uncle this Sunday.", a:"am going to", opts:["am going to","will","was going to","have been going to"], cn:"这个周日我打算去看望叔叔。", tip:"计划/打算 → be going to"},
  {q:"Look at the dark clouds! It _____ (rain).", a:"is going to rain", opts:["is going to rain","will rain","rains","rained"], cn:"看那些乌云！要下雨了。", tip:"根据迹象判断 → be going to"},

  // ── 现在进行时 (12题) ──────────────────────────────────────
  {q:"She _____ (read) a book right now.", a:"is reading", opts:["is reading","reads","read","has read"], cn:"她现在正在看书。", tip:"right now → 现在进行时"},
  {q:"They _____ (play) football in the park at the moment.", a:"are playing", opts:["are playing","play","played","have played"], cn:"他们此刻正在公园里踢足球。", tip:"at the moment → 现在进行时"},
  {q:"He _____ (always/complain) about the weather.", a:"is always complaining", opts:["is always complaining","always complains","always complained","has always complained"], cn:"他总是抱怨天气。", tip:"always + 进行时，表不满/抱怨"},
  {q:"Listen! Someone _____ (knock) at the door.", a:"is knocking", opts:["is knocking","knocks","knocked","has knocked"], cn:"听！有人在敲门。", tip:"Listen! → 现在进行时"},
  {q:"Look! The children _____ (swim) in the pool.", a:"are swimming", opts:["are swimming","swim","swam","have swum"], cn:"看！孩子们在游泳池里游泳。", tip:"Look! → 现在进行时"},
  {q:"I _____ (not/watch) TV now. I'm studying.", a:"am not watching", opts:["am not watching","don't watch","didn't watch","haven't watched"], cn:"我现在没看电视，我在学习。", tip:"now → 现在进行时否定"},
  {q:"What _____ you _____ (do) these days?", a:"are...doing", opts:["are...doing","do...do","did...do","have...done"], cn:"你这些天在做什么？", tip:"these days → 现在进行时"},
  {q:"She _____ (leave) for Shanghai tomorrow.", a:"is leaving", opts:["is leaving","leaves","left","will leave"], cn:"她明天动身去上海。", tip:"表近期计划 → 现在进行时表将来"},
  {q:"We _____ (have) dinner at 7 tonight.", a:"are having", opts:["are having","have","had","will have"], cn:"我们今晚7点吃晚饭。", tip:"表安排好的计划 → 现在进行时表将来"},
  {q:"He _____ (study) very hard these days for the exam.", a:"is studying", opts:["is studying","studies","studied","has studied"], cn:"他这些天为考试学习很努力。", tip:"these days → 现在进行时"},
  {q:"Don't disturb her. She _____ (sleep).", a:"is sleeping", opts:["is sleeping","sleeps","slept","has slept"], cn:"别打扰她，她在睡觉。", tip:"此刻正在 → 现在进行时"},
  {q:"I _____ (think) about changing my job.", a:"am thinking", opts:["am thinking","think","thought","have thought"], cn:"我在考虑换工作。", tip:"think about = 考虑，用进行时"},

  // ── 过去进行时 (12题) ──────────────────────────────────────
  {q:"She _____ (cook) dinner when the phone rang.", a:"was cooking", opts:["was cooking","cooked","cooks","has cooked"], cn:"电话响的时候她正在做饭。", tip:"when + 打断 → 过去进行时"},
  {q:"They _____ (watch) TV at 8 o'clock last night.", a:"were watching", opts:["were watching","watched","watch","have watched"], cn:"昨晚8点他们正在看电视。", tip:"过去某个具体时刻 → 过去进行时"},
  {q:"While I _____ (walk) home, I met an old friend.", a:"was walking", opts:["was walking","walked","walk","have walked"], cn:"我走路回家时遇到了一位老朋友。", tip:"while + 背景动作 → 过去进行时"},
  {q:"What _____ you _____ (do) at 3 pm yesterday?", a:"were...doing", opts:["were...doing","did...do","do...do","have...done"], cn:"你昨天下午3点在做什么？", tip:"过去某刻 → 过去进行时"},
  {q:"He _____ (sleep) when the earthquake struck.", a:"was sleeping", opts:["was sleeping","slept","sleeps","has slept"], cn:"地震发生时他正在睡觉。", tip:"when + 突发事件 → 过去进行时"},
  {q:"While she _____ (study), her brother _____ (play) games.", a:"was studying...was playing", opts:["was studying...was playing","studied...played","studies...plays","has studied...has played"], cn:"她学习的时候，她弟弟在玩游戏。", tip:"while 两个同时进行的过去动作"},
  {q:"At this time yesterday, I _____ (fly) to London.", a:"was flying", opts:["was flying","flew","fly","have flown"], cn:"昨天这个时候我正在飞往伦敦。", tip:"at this time yesterday → 过去进行时"},
  {q:"She _____ (not/listen) when the teacher explained the rule.", a:"wasn't listening", opts:["wasn't listening","didn't listen","doesn't listen","hasn't listened"], cn:"老师解释规则时她没在听。", tip:"过去某段时间没有在做 → 过去进行时否定"},
  {q:"The children _____ (play) outside when it started to rain.", a:"were playing", opts:["were playing","played","play","have played"], cn:"开始下雨时孩子们正在外面玩。", tip:"when + 短暂动作打断 → 过去进行时"},
  {q:"I _____ (read) a novel from 7 to 9 last night.", a:"was reading", opts:["was reading","read","am reading","have read"], cn:"昨晚7点到9点我在看小说。", tip:"过去一段持续时间 → 过去进行时"},
  {q:"He _____ (drive) too fast when the accident happened.", a:"was driving", opts:["was driving","drove","drives","has driven"], cn:"事故发生时他开得太快了。", tip:"when + 打断 → 过去进行时"},
  {q:"She _____ (always/borrow) my things without asking.", a:"was always borrowing", opts:["was always borrowing","always borrowed","always borrows","has always borrowed"], cn:"她总是不问就借我的东西。(过去习惯性抱怨)", tip:"always + 过去进行时，表过去的不满"},

  // ── 现在完成时 (15题) ──────────────────────────────────────
  {q:"She _____ (live) here since 2015.", a:"has lived", opts:["has lived","lived","lives","is living"], cn:"她从2015年起就住在这里。", tip:"since + 时间点 → 现在完成时"},
  {q:"I _____ (already/finish) my homework.", a:"have already finished", opts:["have already finished","already finished","already finish","am already finishing"], cn:"我已经完成作业了。", tip:"already → 现在完成时"},
  {q:"_____ you ever _____ (be) to Japan?", a:"Have...been", opts:["Have...been","Did...go","Do...go","Are...going"], cn:"你去过日本吗？", tip:"ever → 现在完成时，表经历"},
  {q:"He _____ (not/see) his parents for three months.", a:"hasn't seen", opts:["hasn't seen","didn't see","doesn't see","isn't seeing"], cn:"他三个月没见父母了。", tip:"for + 时间段 → 现在完成时"},
  {q:"They _____ (just/arrive) at the hotel.", a:"have just arrived", opts:["have just arrived","just arrived","just arrive","are just arriving"], cn:"他们刚到酒店。", tip:"just → 现在完成时"},
  {q:"She _____ (read) this book three times.", a:"has read", opts:["has read","read","reads","is reading"], cn:"她已经读了这本书三遍了。", tip:"次数 → 现在完成时，表经历"},
  {q:"I _____ (lose) my keys. I can't find them anywhere.", a:"have lost", opts:["have lost","lost","lose","am losing"], cn:"我把钥匙弄丢了，到处找不到。", tip:"结果影响现在 → 现在完成时"},
  {q:"He _____ (work) here for ten years.", a:"has worked", opts:["has worked","worked","works","is working"], cn:"他在这里工作了十年了。", tip:"for + 时间段 → 现在完成时"},
  {q:"She _____ (never/eat) sushi before.", a:"has never eaten", opts:["has never eaten","never ate","never eats","is never eating"], cn:"她以前从没吃过寿司。", tip:"never + before → 现在完成时"},
  {q:"This is the best movie I _____ (ever/see).", a:"have ever seen", opts:["have ever seen","ever saw","ever see","am ever seeing"], cn:"这是我看过的最好的电影。", tip:"最高级 + ever → 现在完成时"},
  {q:"I _____ (know) him since we were children.", a:"have known", opts:["have known","knew","know","am knowing"], cn:"我们从小就认识了。", tip:"since → 现在完成时"},
  {q:"She _____ (already/leave). You just missed her.", a:"has already left", opts:["has already left","already left","already leaves","is already leaving"], cn:"她已经走了。你刚好错过她。", tip:"already → 现在完成时"},
  {q:"How long _____ you _____ (study) English?", a:"have...studied", opts:["have...studied","did...study","do...study","are...studying"], cn:"你学英语多久了？", tip:"how long → 现在完成时"},
  {q:"We _____ (not/decide) where to go yet.", a:"haven't decided", opts:["haven't decided","didn't decide","don't decide","aren't deciding"], cn:"我们还没决定去哪里。", tip:"yet → 现在完成时"},
  {q:"It's the first time I _____ (fly) on a plane.", a:"have flown", opts:["have flown","flew","fly","am flying"], cn:"这是我第一次坐飞机。", tip:"It's the first time + 现在完成时"},

  // ── 过去完成时 (15题) ──────────────────────────────────────
  {q:"By the time I arrived, the movie _____ (already/start).", a:"had already started", opts:["had already started","already started","has already started","was already starting"], cn:"我到的时候电影已经开始了。", tip:"by the time + 过去时 → 过去完成时"},
  {q:"She told me she _____ (visit) Paris before.", a:"had visited", opts:["had visited","visited","has visited","was visiting"], cn:"她告诉我她以前去过巴黎。", tip:"过去的过去 → 过去完成时"},
  {q:"After he _____ (finish) his homework, he went to bed.", a:"had finished", opts:["had finished","finished","has finished","was finishing"], cn:"做完作业后他就去睡觉了。", tip:"after + 先发生的动作 → 过去完成时"},
  {q:"He _____ (never/see) a real elephant until he visited Africa.", a:"had never seen", opts:["had never seen","never saw","has never seen","was never seeing"], cn:"直到去了非洲他才第一次看到真正的大象。", tip:"until + 过去时 → 过去完成时"},
  {q:"They _____ (leave) before I got there.", a:"had left", opts:["had left","left","have left","were leaving"], cn:"我到那里之前他们就已经走了。", tip:"before + 过去时 → 过去完成时"},
  {q:"She realized she _____ (forget) her wallet at home.", a:"had forgotten", opts:["had forgotten","forgot","has forgotten","was forgetting"], cn:"她意识到她把钱包落在家里了。", tip:"realized (过去) + 更早的动作 → 过去完成时"},
  {q:"I _____ (not/eat) anything all day, so I was very hungry.", a:"had not eaten", opts:["had not eaten","didn't eat","haven't eaten","wasn't eating"], cn:"我一整天什么都没吃，所以非常饿。", tip:"过去某时之前的持续状态 → 过去完成时"},
  {q:"By 2020, he _____ (live) in London for ten years.", a:"had lived", opts:["had lived","lived","has lived","was living"], cn:"到2020年他已经在伦敦住了十年了。", tip:"by + 过去时间 → 过去完成时"},
  {q:"She said she _____ (already/read) the book.", a:"had already read", opts:["had already read","already read","has already read","was already reading"], cn:"她说她已经读了那本书了。", tip:"间接引语中更早的动作 → 过去完成时"},
  {q:"Hardly _____ he _____ (arrive) when it began to snow.", a:"had...arrived", opts:["had...arrived","did...arrive","has...arrived","was...arriving"], cn:"他刚到就开始下雪了。", tip:"hardly had...when 一...就..."},
  {q:"No sooner _____ she _____ (leave) than it started raining.", a:"had...left", opts:["had...left","did...leave","has...left","was...leaving"], cn:"她刚走就开始下雨了。", tip:"no sooner had...than 一...就..."},
  {q:"I wish I _____ (study) harder when I was young.", a:"had studied", opts:["had studied","studied","have studied","was studying"], cn:"我真希望年轻时更努力学习。", tip:"wish + had done 虚拟语气，与过去事实相反"},
  {q:"If I _____ (know) about the party, I would have gone.", a:"had known", opts:["had known","knew","have known","was knowing"], cn:"如果我知道有派对的话，我就会去了。", tip:"if + had done 虚拟语气，与过去事实相反"},
  {q:"He _____ (work) there for five years before he was promoted.", a:"had worked", opts:["had worked","worked","has worked","was working"], cn:"他在那里工作了五年后才升职。", tip:"before + 过去时 → 之前的持续 → 过去完成时"},
  {q:"The train _____ (already/leave) when we arrived at the station.", a:"had already left", opts:["had already left","already left","has already left","was already leaving"], cn:"我们到车站时火车已经开走了。", tip:"when + 过去时 → 更早的动作 → 过去完成时"},

  // ── 现在完成进行时 (10题) ──────────────────────────────────────
  {q:"She _____ (study) English for five years.", a:"has been studying", opts:["has been studying","studied","studies","is studying"], cn:"她学英语已经五年了。（一直在学）", tip:"for + 时间段 + 强调持续进行 → 现在完成进行时"},
  {q:"I _____ (wait) for you for two hours!", a:"have been waiting", opts:["have been waiting","waited","am waiting","have waited"], cn:"我已经等你两个小时了！", tip:"强调等待一直在进行 → 现在完成进行时"},
  {q:"He _____ (work) on this project since Monday.", a:"has been working", opts:["has been working","worked","works","is working"], cn:"他从周一起就一直在做这个项目。", tip:"since + 强调持续 → 现在完成进行时"},
  {q:"It _____ (rain) all day. The ground is wet.", a:"has been raining", opts:["has been raining","rained","rains","is raining"], cn:"下了一整天的雨了，地面很湿。", tip:"all day + 影响现在 → 现在完成进行时"},
  {q:"They _____ (build) the bridge for three years.", a:"have been building", opts:["have been building","built","build","are building"], cn:"他们建这座桥已经三年了。（还在建）", tip:"for + 强调未完成/持续 → 现在完成进行时"},
  {q:"She _____ (teach) at this school since 2010.", a:"has been teaching", opts:["has been teaching","taught","teaches","is teaching"], cn:"她从2010年起就一直在这所学校教书。", tip:"since + 强调持续 → 现在完成进行时"},
  {q:"I _____ (try) to call you all morning.", a:"have been trying", opts:["have been trying","tried","try","am trying"], cn:"我整个上午都在试着给你打电话。", tip:"all morning + 强调反复尝试 → 现在完成进行时"},
  {q:"You look tired. _____ you _____ (run)?", a:"Have...been running", opts:["Have...been running","Did...run","Do...run","Are...running"], cn:"你看起来很累。你一直在跑步吗？", tip:"从现在状态推断 → 现在完成进行时"},
  {q:"He _____ (write) his novel for two years now.", a:"has been writing", opts:["has been writing","wrote","writes","is writing"], cn:"他写小说已经写了两年了。", tip:"for + now → 现在完成进行时"},
  {q:"We _____ (live) in this city since we were born.", a:"have been living", opts:["have been living","lived","live","are living"], cn:"我们从出生起就一直住在这座城市。", tip:"since + 强调一直持续 → 现在完成进行时"},

  // ── 过去将来时 (8题) ──────────────────────────────────────
  {q:"He said he _____ (come) the next day.", a:"would come", opts:["would come","will come","comes","came"], cn:"他说他第二天会来。", tip:"间接引语 → will 变 would"},
  {q:"She told me she _____ (call) me later.", a:"would call", opts:["would call","will call","calls","called"], cn:"她告诉我她稍后会给我打电话。", tip:"间接引语 → will 变 would"},
  {q:"I thought it _____ (rain) soon.", a:"would rain", opts:["would rain","will rain","rains","rained"], cn:"我以为马上要下雨了。", tip:"thought + would → 过去将来时"},
  {q:"He promised he _____ (help) me.", a:"would help", opts:["would help","will help","helps","helped"], cn:"他答应会帮我。", tip:"promised → would 过去将来时"},
  {q:"We didn't know when the bus _____ (arrive).", a:"would arrive", opts:["would arrive","will arrive","arrives","arrived"], cn:"我们不知道公交车什么时候到。", tip:"didn't know → would 过去将来时"},
  {q:"She was sure she _____ (pass) the exam.", a:"would pass", opts:["would pass","will pass","passes","passed"], cn:"她确信她会通过考试的。", tip:"was sure → would 过去将来时"},
  {q:"He decided that he _____ (study) abroad.", a:"would study", opts:["would study","will study","studies","studied"], cn:"他决定去国外留学。", tip:"decided → would 过去将来时"},
  {q:"They agreed they _____ (meet) at noon.", a:"would meet", opts:["would meet","will meet","meet","met"], cn:"他们约定中午见面。", tip:"agreed → would 过去将来时"},

  // ── 被动语态 (15题) ──────────────────────────────────────
  {q:"English _____ (speak) all over the world.", a:"is spoken", opts:["is spoken","speaks","spoke","has spoken"], cn:"英语在全世界被使用。", tip:"一般现在时被动 → is/are + 过去分词"},
  {q:"The bridge _____ (build) in 1990.", a:"was built", opts:["was built","built","is built","has been built"], cn:"这座桥建于1990年。", tip:"一般过去时被动 → was/were + 过去分词"},
  {q:"A new hospital _____ (build) in our city next year.", a:"will be built", opts:["will be built","is built","was built","has been built"], cn:"明年我们城市将建一座新医院。", tip:"一般将来时被动 → will be + 过去分词"},
  {q:"The work _____ (do) by the time he arrived.", a:"had been done", opts:["had been done","was done","has been done","is done"], cn:"他到达时工作已经做完了。", tip:"过去完成时被动 → had been + 过去分词"},
  {q:"The flowers _____ (water) every day.", a:"are watered", opts:["are watered","water","watered","have watered"], cn:"花每天都被浇水。", tip:"一般现在时被动 → are + 过去分词"},
  {q:"The letter _____ (write) by my mother.", a:"was written", opts:["was written","wrote","is written","has been written"], cn:"这封信是我妈妈写的。", tip:"一般过去时被动 → was + 过去分词"},
  {q:"The project _____ (complete) recently.", a:"has been completed", opts:["has been completed","completed","is completed","was completed"], cn:"这个项目最近完成了。", tip:"现在完成时被动 → has been + 过去分词"},
  {q:"The car _____ (repair) right now.", a:"is being repaired", opts:["is being repaired","is repaired","was repaired","has been repaired"], cn:"车正在被修理。", tip:"现在进行时被动 → is being + 过去分词"},
  {q:"When I arrived, the room _____ (clean).", a:"was being cleaned", opts:["was being cleaned","was cleaned","is being cleaned","has been cleaned"], cn:"我到达时房间正在被打扫。", tip:"过去进行时被动 → was being + 过去分词"},
  {q:"She _____ (give) a prize for her excellent performance.", a:"was given", opts:["was given","gave","is given","has given"], cn:"她因出色的表现获了奖。", tip:"被动语态 → was given"},
  {q:"The cake _____ (make) by my grandmother.", a:"was made", opts:["was made","made","is made","has made"], cn:"蛋糕是我奶奶做的。", tip:"一般过去时被动 → was + 过去分词"},
  {q:"This machine _____ (use) to make paper.", a:"is used", opts:["is used","uses","used","has used"], cn:"这台机器被用来造纸。", tip:"be used to do 被用来做"},
  {q:"The children _____ (take) care of by their grandparents.", a:"are taken", opts:["are taken","take","took","have taken"], cn:"孩子们由祖父母照顾。", tip:"一般现在时被动 → are + 过去分词"},
  {q:"It _____ (say) that he is the richest man in town.", a:"is said", opts:["is said","says","said","has said"], cn:"据说他是镇上最富有的人。", tip:"It is said that... 据说"},
  {q:"The museum _____ (visit) by thousands of people every year.", a:"is visited", opts:["is visited","visits","visited","has visited"], cn:"这个博物馆每年有数千人参观。", tip:"一般现在时被动"},

  // ── 虚拟语气 (15题) ──────────────────────────────────────
  {q:"If I _____ (be) you, I would accept the offer.", a:"were", opts:["were","am","was","have been"], cn:"如果我是你，我会接受这个提议。", tip:"与现在事实相反 → if + were"},
  {q:"If she _____ (study) harder, she would pass the exam.", a:"studied", opts:["studied","studies","had studied","would study"], cn:"如果她更努力学习，就会通过考试的。", tip:"与现在事实相反 → if + 过去式"},
  {q:"If I _____ (know) his number, I would call him.", a:"knew", opts:["knew","know","had known","would know"], cn:"如果我知道他的电话号码，我就会打给他。", tip:"与现在事实相反 → if + 过去式"},
  {q:"If he _____ (come) earlier, he would have caught the train.", a:"had come", opts:["had come","came","has come","would come"], cn:"如果他来得早一点，就赶上火车了。", tip:"与过去事实相反 → if + had done"},
  {q:"I wish I _____ (can) fly like a bird.", a:"could", opts:["could","can","will","may"], cn:"我真希望能像鸟一样飞。", tip:"wish + 过去式 → 与现在事实相反"},
  {q:"She suggested that he _____ (go) to see a doctor.", a:"go", opts:["go","goes","went","should go"], cn:"她建议他去看医生。", tip:"suggest + that + (should) + 动词原形"},
  {q:"It is necessary that everyone _____ (be) on time.", a:"be", opts:["be","is","was","will be"], cn:"每个人都准时到是必要的。", tip:"It is necessary that + (should) + be"},
  {q:"If it _____ (not/rain) yesterday, we would have gone hiking.", a:"hadn't rained", opts:["hadn't rained","didn't rain","doesn't rain","won't rain"], cn:"如果昨天没下雨，我们就去远足了。", tip:"与过去事实相反 → if + had not done"},
  {q:"He talks as if he _____ (know) everything.", a:"knew", opts:["knew","knows","had known","would know"], cn:"他说话好像什么都知道似的。", tip:"as if + 过去式 → 与现在事实相反"},
  {q:"I wish I _____ (not/say) that to her.", a:"hadn't said", opts:["hadn't said","didn't say","don't say","won't say"], cn:"我真希望我没对她说那句话。", tip:"wish + had not done → 与过去事实相反"},
  {q:"The teacher demanded that the students _____ (hand) in their papers.", a:"hand", opts:["hand","hands","handed","would hand"], cn:"老师要求学生交论文。", tip:"demand + that + (should) + 动词原形"},
  {q:"If only I _____ (have) more time!", a:"had", opts:["had","have","has","would have"], cn:"要是我有更多时间就好了！", tip:"if only + 过去式 → 与现在事实相反"},
  {q:"It's high time we _____ (leave).", a:"left", opts:["left","leave","have left","will leave"], cn:"我们该走了。", tip:"It's high time + 过去式"},
  {q:"Would rather you _____ (not/smoke) here.", a:"didn't smoke", opts:["didn't smoke","don't smoke","won't smoke","haven't smoked"], cn:"我宁愿你不在这里抽烟。", tip:"would rather sb. + 过去式"},
  {q:"But for your help, I _____ (fail).", a:"would have failed", opts:["would have failed","failed","will fail","have failed"], cn:"要不是你帮忙，我就失败了。", tip:"but for = if it were not for 虚拟语气"},

  // ── 时态综合辨析 (16题) ──────────────────────────────────────
  {q:"She _____ (go) to Beijing twice. She knows the city well.", a:"has been", opts:["has been","went","goes","is going"], cn:"她去过北京两次，对那座城市很了解。", tip:"has been to 去过（经历），have gone to 去了（不在这里）"},
  {q:"He _____ (go) to Shanghai. He isn't here now.", a:"has gone", opts:["has gone","has been","went","goes"], cn:"他去上海了，他现在不在这里。", tip:"has gone to 去了（不在此处）"},
  {q:"I _____ (just/finish) reading the book. It's great!", a:"have just finished", opts:["have just finished","just finished","just finish","am just finishing"], cn:"我刚读完这本书，太棒了！", tip:"just → 现在完成时"},
  {q:"She _____ (study) in this school for three years. She's still here.", a:"has studied", opts:["has studied","studied","studies","is studying"], cn:"她在这所学校学习了三年了。（还在）", tip:"for + 仍在持续 → 现在完成时"},
  {q:"She _____ (study) in this school for three years. Then she moved.", a:"studied", opts:["studied","has studied","studies","was studying"], cn:"她在这所学校学习了三年，然后搬走了。", tip:"then she moved → 已结束 → 一般过去时"},
  {q:"By next July, he _____ (work) here for 20 years.", a:"will have worked", opts:["will have worked","has worked","worked","will work"], cn:"到明年七月，他就在这里工作20年了。", tip:"by + 将来时间 → 将来完成时"},
  {q:"This time next week, I _____ (lie) on a beach.", a:"will be lying", opts:["will be lying","will lie","lie","am lying"], cn:"下周这个时候我会躺在沙滩上。", tip:"将来某时刻正在 → 将来进行时"},
  {q:"When I entered the room, I found that someone _____ (steal) my laptop.", a:"had stolen", opts:["had stolen","stole","has stolen","was stealing"], cn:"我进房间时发现有人偷了我的电脑。", tip:"entered (过去) 之前发生 → 过去完成时"},
  {q:"She said she _____ (be) a teacher for ten years by then.", a:"had been", opts:["had been","has been","was","would be"], cn:"她说到那时她已经当了十年老师了。", tip:"间接引语 + by then → 过去完成时"},
  {q:"I _____ (read) this book before, so I know the story.", a:"have read", opts:["have read","read","am reading","had read"], cn:"我以前读过这本书，所以我知道故事内容。", tip:"before + 结果影响现在 → 现在完成时"},
  {q:"The house _____ (paint) blue. It looks nice.", a:"has been painted", opts:["has been painted","was painted","is painted","painted"], cn:"房子被漆成蓝色了，看起来很漂亮。", tip:"结果影响现在 → 现在完成时被动"},
  {q:"Don't call me at 8 tonight. I _____ (have) dinner.", a:"will be having", opts:["will be having","will have","have","am having"], cn:"今晚8点别给我打电话，我会在吃晚饭。", tip:"将来某时刻正在 → 将来进行时"},
  {q:"By the end of this year, I _____ (save) enough money for a trip.", a:"will have saved", opts:["will have saved","have saved","saved","will save"], cn:"到今年年底，我将攒够旅行的钱。", tip:"by the end of + 将来 → 将来完成时"},
  {q:"He _____ (learn) 2000 words by the time he finishes high school.", a:"will have learned", opts:["will have learned","has learned","learned","will learn"], cn:"到他高中毕业时，他将学会2000个单词。", tip:"by the time + 将来 → 将来完成时"},
  {q:"I didn't go to the cinema because I _____ (see) the film.", a:"had seen", opts:["had seen","saw","have seen","was seeing"], cn:"我没去看电影因为我已经看过了。", tip:"didn't go (过去) + 原因在更早 → 过去完成时"},
  {q:"She _____ (cook) for three hours by the time the guests arrive.", a:"will have been cooking", opts:["will have been cooking","has been cooking","was cooking","will cook"], cn:"到客人来的时候她将已经做了三小时的饭了。", tip:"by the time + 将来 + 持续 → 将来完成进行时"},

  // ── 补充：将来完成时/将来进行时/过去完成进行时/情态动词+完成时 (40题) ──────
  {q:"By 2030, scientists _____ (discover) a cure for cancer.", a:"will have discovered", opts:["will have discovered","have discovered","discovered","will discover"], cn:"到2030年科学家将已经发现了癌症的治疗方法。", tip:"by + 将来时间 → 将来完成时"},
  {q:"This time tomorrow, she _____ (sit) in the exam hall.", a:"will be sitting", opts:["will be sitting","will sit","sits","is sitting"], cn:"明天这个时候她会正在考场里。", tip:"this time tomorrow → 将来进行时"},
  {q:"He _____ (wait) for two hours before she finally appeared.", a:"had been waiting", opts:["had been waiting","waited","has been waiting","was waiting"], cn:"在她终于出现之前他已经等了两个小时。", tip:"过去的持续 + before → 过去完成进行时"},
  {q:"They _____ (travel) for six hours before the car broke down.", a:"had been traveling", opts:["had been traveling","traveled","have been traveling","were traveling"], cn:"在车抛锚之前他们已经开了六个小时。", tip:"过去的持续 → 过去完成进行时"},
  {q:"She _____ (cry) for a long time before her mother came.", a:"had been crying", opts:["had been crying","cried","has been crying","was crying"], cn:"在妈妈来之前她已经哭了很长时间。", tip:"过去持续 + before → 过去完成进行时"},
  {q:"He must _____ (forget) about the meeting.", a:"have forgotten", opts:["have forgotten","forget","forgot","be forgetting"], cn:"他一定是忘了会议。", tip:"must have done 对过去的肯定推测"},
  {q:"She can't _____ (be) at the party. I saw her at the library.", a:"have been", opts:["have been","be","been","being"], cn:"她不可能在派对上，我在图书馆看到她了。", tip:"can't have done 对过去的否定推测"},
  {q:"He may _____ (miss) the train.", a:"have missed", opts:["have missed","miss","missed","be missing"], cn:"他可能错过了火车。", tip:"may have done 对过去的不确定推测"},
  {q:"She should _____ (tell) him the truth earlier.", a:"have told", opts:["have told","tell","told","be telling"], cn:"她本应该早点告诉他真相。", tip:"should have done 本应该做而没做"},
  {q:"You needn't _____ (buy) so much food. We won't eat it all.", a:"have bought", opts:["have bought","buy","bought","be buying"], cn:"你不必买这么多食物，我们吃不完的。", tip:"needn't have done 本不必做但做了"},
  {q:"He could _____ (win) the game if he had tried harder.", a:"have won", opts:["have won","win","won","be winning"], cn:"如果他更努力一些就能赢了。", tip:"could have done 本可以做而没做"},
  {q:"By this time next year, I _____ (graduate) from university.", a:"will have graduated", opts:["will have graduated","have graduated","graduated","will graduate"], cn:"到明年这个时候我将已经大学毕业了。", tip:"by this time next year → 将来完成时"},
  {q:"At 10 o'clock tomorrow, I _____ (take) an exam.", a:"will be taking", opts:["will be taking","will take","take","am taking"], cn:"明天10点钟我会正在考试。", tip:"将来某时刻正在 → 将来进行时"},
  {q:"She _____ (not/should/spend) so much money on that dress.", a:"shouldn't have spent", opts:["shouldn't have spent","shouldn't spend","didn't spend","won't spend"], cn:"她不应该在那条裙子上花那么多钱。", tip:"shouldn't have done 不应该做但做了"},
  {q:"He might _____ (leave) already. His car is not here.", a:"have left", opts:["have left","leave","left","be leaving"], cn:"他可能已经走了，他的车不在这里。", tip:"might have done 对过去的推测"},
  {q:"When you come back, I _____ (clean) the whole house.", a:"will have cleaned", opts:["will have cleaned","have cleaned","cleaned","will clean"], cn:"你回来时我将已经打扫了整栋房子。", tip:"when you come back (将来) → 将来完成时"},
  {q:"She _____ (teach) for 30 years by the time she retires.", a:"will have been teaching", opts:["will have been teaching","has been teaching","was teaching","will teach"], cn:"到她退休时她将已经教了30年书了。", tip:"by the time + 将来 + 持续 → 将来完成进行时"},
  {q:"I _____ (study) all day. I need a break.", a:"have been studying", opts:["have been studying","studied","study","am studying"], cn:"我学了一整天了，需要休息一下。", tip:"all day + 仍在进行 → 现在完成进行时"},
  {q:"She must _____ (work) very hard. She looks exhausted.", a:"have been working", opts:["have been working","work","worked","be working"], cn:"她一定一直在非常努力地工作，她看起来精疲力尽。", tip:"must have been doing 对过去持续状态的推测"},
  {q:"He _____ (play) football before he hurt his knee.", a:"had been playing", opts:["had been playing","played","has played","was playing"], cn:"他受伤之前一直在踢足球。", tip:"过去持续 + before → 过去完成进行时"},
  {q:"By the end of the month, they _____ (live) here for a decade.", a:"will have lived", opts:["will have lived","have lived","lived","will live"], cn:"到月底他们就在这里住满十年了。", tip:"by the end of + 将来 → 将来完成时"},
  {q:"Don't phone between 7 and 8. We _____ (have) dinner.", a:"will be having", opts:["will be having","will have","have","are having"], cn:"7点到8点之间别打电话，我们会在吃晚饭。", tip:"将来某段时间正在 → 将来进行时"},
  {q:"The road is wet. It _____ (rain).", a:"has been raining", opts:["has been raining","rained","rains","is raining"], cn:"路面湿了。一直在下雨。", tip:"从现在证据推断 → 现在完成进行时"},
  {q:"She _____ (live) alone since her husband died.", a:"has been living", opts:["has been living","lived","lives","was living"], cn:"自从丈夫去世后她一直独居。", tip:"since + 强调持续至今 → 现在完成进行时"},
  {q:"The workers _____ (repair) the road for three months before it was finished.", a:"had been repairing", opts:["had been repairing","repaired","have been repairing","were repairing"], cn:"工人们修路修了三个月才完工。", tip:"过去持续 + before → 过去完成进行时"},
  {q:"If I _____ (be) taller, I could play basketball.", a:"were", opts:["were","am","was","have been"], cn:"如果我更高一些就能打篮球了。", tip:"与现在事实相反 → if + were"},
  {q:"He speaks French fluently as if he _____ (live) in France for years.", a:"had lived", opts:["had lived","lived","has lived","lives"], cn:"他法语说得很流利，好像在法国住了好多年似的。", tip:"as if + had done 与过去事实相反"},
  {q:"It is required that each student _____ (wear) a uniform.", a:"wear", opts:["wear","wears","wore","should wear"], cn:"要求每个学生穿校服。", tip:"It is required that + (should) + 动词原形"},
  {q:"I'd rather you _____ (come) tomorrow instead of today.", a:"came", opts:["came","come","will come","have come"], cn:"我宁愿你明天来而不是今天。", tip:"would rather sb. + 过去式"},
  {q:"If only she _____ (not/leave) so early!", a:"hadn't left", opts:["hadn't left","didn't leave","doesn't leave","won't leave"], cn:"要是她没有走那么早就好了！", tip:"if only + had not done 与过去事实相反"},
  {q:"He ordered that the goods _____ (deliver) immediately.", a:"be delivered", opts:["be delivered","were delivered","are delivered","would be delivered"], cn:"他命令立即交货。", tip:"order + that + (should) be + 过去分词"},
  {q:"It's about time you _____ (start) working on your project.", a:"started", opts:["started","start","have started","will start"], cn:"你该开始做你的项目了。", tip:"It's about time + 过去式"},
  {q:"She acted as though nothing _____ (happen).", a:"had happened", opts:["had happened","happened","has happened","happens"], cn:"她表现得好像什么都没发生过。", tip:"as though + had done 与过去事实相反"},
  {q:"The teacher recommended that he _____ (read) more books.", a:"read", opts:["read","reads","reading","would read"], cn:"老师建议他多读书。", tip:"recommend + that + (should) + 动词原形"},
  {q:"Suppose you _____ (win) the lottery, what would you do?", a:"won", opts:["won","win","had won","would win"], cn:"假如你中了彩票，你会做什么？", tip:"suppose + 过去式 → 虚拟语气"},
  {q:"He wishes he _____ (not/waste) so much time playing games.", a:"hadn't wasted", opts:["hadn't wasted","didn't waste","doesn't waste","won't waste"], cn:"他真希望自己没有浪费那么多时间玩游戏。", tip:"wish + had not done → 与过去事实相反"},
  {q:"Were I in your position, I _____ (accept) the offer.", a:"would accept", opts:["would accept","accept","accepted","have accepted"], cn:"如果我处于你的位置，我会接受这个提议。", tip:"Were I = If I were 虚拟语气倒装"},
  {q:"Had he studied harder, he _____ (pass) the exam.", a:"would have passed", opts:["would have passed","passed","has passed","will pass"], cn:"要是他学得更努力，就通过考试了。", tip:"Had he = If he had 虚拟语气倒装"},
  {q:"She _____ (not/must/tell) him. He still doesn't know.", a:"can't have told", opts:["can't have told","mustn't tell","didn't tell","won't tell"], cn:"她不可能告诉了他，他还是不知道。", tip:"can't have done 不可能做了某事"},
  {q:"You _____ (ought to/apologize) to her yesterday.", a:"ought to have apologized", opts:["ought to have apologized","ought to apologize","apologized","will apologize"], cn:"你昨天本应该向她道歉的。", tip:"ought to have done 本应该做而没做"},
];
